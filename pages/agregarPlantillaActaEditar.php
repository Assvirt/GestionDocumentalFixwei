              ...
              <form  action="controlador/actas/controllerPlantillas" method="POST" role="form" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    ?>
                       <div class="form-group ">
                            <textarea name="editor1" required><?php echo $extraerPlantilla['acta'];?></textarea>
                        </div>
                    <?php
                       }
                    ?>
                ...
                <div class="card-footer" >
                  <button type="submit" name="actualizarPlantilla"  id="agregar_registro" class="btn btn-primary float-right">Actualizar</button>
                </div>
                <?php
                }
                ?>
