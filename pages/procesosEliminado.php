...
<!DOCTYPE html>
<html>
    <title>Procesos eliminados</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Procesos eliminados</li>
            </ol>
          </div>
        </div>
        <div>
              ...
              <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center" id="example">
                  ...
                  <tbody>
                    ...
                    $data = $mysqli->query("SELECT * FROM procesos WHERE estado='Eliminado' ORDER BY nombre ASC")or die(mysqli_error());
