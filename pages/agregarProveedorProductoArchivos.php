    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
                Adjuntando documentos del producto<br>
                <?php 
                $consultandoProducto=$mysqli->query("SELECT * FROM  proveedorProductos WHERE id='".$_POST['validacionAgregar']."' ");
                $extraerConsultaProductos=$consultandoProducto->fetch_array(MYSQLI_ASSOC);
                echo $extraerConsultaProductos['nombre'];
                ?>
            </h1>
          </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                        <form action="proveedoresProductoVer" method="post">
...
<div class="container">
	...
	<div class="file_upload">
		<form action="almacenamientoMultipleProductos/file_upload.php" class="dropzone">
		    <input name="validacionAgregar" value="<?php echo $_POST['validacionAgregar']; ?>" type="hidden">
