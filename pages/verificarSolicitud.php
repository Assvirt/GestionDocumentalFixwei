...
$formulario = 'aprobacionOC'; //Se cambia el nombre del formulario solicitudComprador
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Verificar Solicitud</li>
            </ol>
          </div>
        </div>
        <div>
                ...
                <table class="table table-head-fixed text-center" id="example">
                  ...
                  <tbody>
                     ...
                     while($row = $data->fetch_assoc()){
                         ...
                         if($extraerDatos['aprobador'] == $idparaChat){
                    ...
                    echo"<form action='verificarSolicitudVer' method='POST'>";
