...
$formulario = 'gruposDis'; //Se cambia el nombre del formulario
        ...
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm">
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="grupos"><font color="white"><i class="fa fa-list"></i> Listar grupos</font></a></button>
                        </div>
            ...
            <div class="col-9">
              ...
              <form action="controlador/grupos/controllerGrupos" method="POST"role="form">
                ...
                <div class="card-footer" >
                  <button type="submit" name="agregarGrupo" class="btn btn-primary float-right">Agregar</button>
                </div>
              </form>
            </div>
            </div>    
