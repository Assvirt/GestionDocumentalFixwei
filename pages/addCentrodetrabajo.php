              ...
              <form role="form" action="controlador/centrodetrabajo/controladorcentrodetrabajo" method="POST">
                ...
                <!-- Fin parametros para la activacion de correo y plataforma -->
                  ...
                  <div class="form-group">
                    ...
                    <input autocomplete="off" type="text" class="form-control" name="nombreCentro" id="nombre" placeholder="Centro de trabajo" onkeypress="return ( (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 ||  event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)" required>
                  </div>
                  <div class="form-group">
                    <label for="prefijo">Prefijo</label>
                    <input autocomplete="off" type="text" class="form-control" name="prefijoCentro"id="prefijo" placeholder="Prefijo" onkeypress="return ( (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250  || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)" required>
                  </div>
                  <?php
                  /*
                        require_once'conexion/bd.php';
                        $acentos = $mysqli->query("SET NAMES 'utf8'");
                        $resultado=$mysqli->query("SELECT * FROM cargos ORDER BY id_cargos");
                  ?>
                  <div class="form-group">
                ...
                <div class="card-footer" >
                  <button type="submit" name="AgregarCentro" class="btn btn-primary float-right">Agregar</button>
                </div>
              </form>
            </div>
            </div>    
