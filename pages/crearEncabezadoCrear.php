...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <title>FIXWEI - Crear encabezado</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Crear encabezado</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Crear encabezado</li>
            </ol>
          </div>
        </div>
        <div>
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- form start -->
                ...
                <form  action="controlador/actas/encabezado" method="POST" role="form" enctype="multipart/form-data" >  
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <br>
                           ...
                           <div class="form-group ">
                            ...
                            <div class="form-group ">
                                <textarea name="editor1" required><?php echo $_POST['editor1'];?></textarea>
                            </div>
                      </div>
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-footer" >
                      <button type="submit" name="encabezadoCrear"   class="btn btn-primary float-right">Agregar</button>
                    </div>
                </form>
...
<!--Ckeditor-->
<!-- se comenta esta línea de código para agregar la nueva librería de ckeditor
