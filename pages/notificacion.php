  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>NOTIFICACIONES DEL GRUPO <?php echo $nomGrupo;?></h1>
          </div>
    ...
    <section class="content">
        <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-9">
                    <!-- Default box -->
                    <form action="controlador/controllerNotificaciones" method="POST"> 
                        <div class="card">
                          ...
                          <?php
                            ...
                            $acentos = $mysqli->query("SET NAMES 'utf8'");
                            $data = $mysqli->query("SELECT permisosNotificaciones.plataforma, permisosNotificaciones.correo, permisosNotificaciones.formulario, formularios.* FROM formularios INNER JOIN permisosNotificaciones 
                            WHERE formularios.modulo = 'config' AND permisosNotificaciones.formulario =formularios.idFormulario AND permisosNotificaciones.idGrupo = '$idGrupo' ORDER BY formularios.orden");
                          ?>
                          <div class="card-body">
                                      ...
                                      <tbody>
                                        <?php
                                            while($row = $data->fetch_assoc()){
                                                ...
                                                echo "<td><input class='case' name='".$row['idFormulario']."-plataforma' value='".$row['idFormulario']."-plataforma' type='checkbox' ".$checkListar."></td>";
                                                //echo "<td><input name='".$row['idFormulario']."-correo' value='".$row['idFormulario']."-correo' type='checkbox' ".$checkCrear."></td>";
                                                echo"</tr>";
                                            }
                                        ?>
                                      </tbody>
                    ...
                    <form action="controlador/controllerNotificaciones" method="POST"> 
                        <div class="card">
                          ...
                          <?php
                            ...
                            $acentos = $mysqli->query("SET NAMES 'utf8'");
                            $data = $mysqli->query("SELECT permisosNotificaciones.plataforma, permisosNotificaciones.correo, permisosNotificaciones.formulario, formularios.* FROM formularios INNER JOIN permisosNotificaciones 
                            WHERE formularios.modulo = 'gestionDoc' AND permisosNotificaciones.formulario =formularios.idFormulario AND permisosNotificaciones.idGrupo = '$idGrupo' ORDER BY formularios.orden");
                          ?>
                          <div class="card-body">
                                      ...
                                      <tbody>
                                        <?php
                                            while($row = $data->fetch_assoc()){
                                                ...
                                                echo "<td style='text-align: left;'>".$row['nombre']." ".$row['apellido']."</td>";
                                                echo "<td style='text-align: justify;'>".$row['descripcion']." ".$row['apellido']."</td>";
                                                echo "<td><input class='case2' name='".$row['idFormulario']."-plataforma' value='".$row['idFormulario']."-plataforma' type='checkbox' ".$checkListar."></td>";
                                               // echo "<td><input name='".$row['idFormulario']."-correo' value='".$row['idFormulario']."-correo' type='checkbox' ".$checkCrear."></td>";
                                                echo"</tr>";
                                            }
                                        ?>
                    ...
                    <form action="controlador/controllerNotificaciones" method="POST"> 
                        <div class="card">
                          ...
                          <?php
                            ...
                            $acentos = $mysqli->query("SET NAMES 'utf8'");
                            $data = $mysqli->query("SELECT permisosNotificaciones.plataforma, permisosNotificaciones.correo, permisosNotificaciones.formulario, formularios.* FROM formularios INNER JOIN permisosNotificaciones 
                            WHERE formularios.modulo = 'indi' AND permisosNotificaciones.formulario =formularios.idFormulario AND permisosNotificaciones.idGrupo = '$idGrupo' ORDER BY formularios.orden");
                          ?>
                          <div class="card-body">
                                      ...
                                      <tbody>
                                        <?php
                                            while($row = $data->fetch_assoc()){
                                                ...
                                                echo "<td style='text-align: left;'>".$row['nombre']." ".$row['apellido']."</td>";
                                                echo "<td style='text-align: justify;'>".$row['descripcion']." ".$row['apellido']."</td>";
                                                echo "<td><input class='case3' name='".$row['idFormulario']."-plataforma' value='".$row['idFormulario']."-plataforma' type='checkbox' ".$checkListar."></td>";
                                              //  echo "<td><input name='".$row['idFormulario']."-correo' value='".$row['idFormulario']."-correo' type='checkbox' ".$checkCrear."></td>";
                                                echo"</tr>";
                                            }
                                        ?>
                          ...
                          <div class="card-footer">
                            ...
                            <button type="submit" name="addPermisosIndicadores" class="btn btn-primary float-right">Actualizar</button>
                          </div>
                          <!-- /.card-footer-->
                        </div>
                    </form>
                ...
                <div class="row">
                  ...
                  <div class="col-9">
                    ...
                    <form action="controlador/controllerNotificaciones" method="POST"> 
                        <div class="card">
                          <div class="card-header">
                            <h3 class="card-title">ACTAS E INFORME</h3>
                          ...
                          <?php
                            ...
                            $acentos = $mysqli->query("SET NAMES 'utf8'");
                            $data = $mysqli->query("SELECT permisosNotificaciones.plataforma, permisosNotificaciones.correo, permisosNotificaciones.formulario, formularios.* FROM formularios INNER JOIN permisosNotificaciones 
                            WHERE formularios.modulo = 'actas' AND permisosNotificaciones.formulario =formularios.idFormulario AND permisosNotificaciones.idGrupo = '$idGrupo' ORDER BY formularios.orden");
                          ?>
                          <div class="card-body">
                                      ...
                                      <tbody>
                                        <?php
                                            while($row = $data->fetch_assoc()){
                                                ...
                                                echo "<td style='text-align: left;'>".$row['nombre']." ".$row['apellido']."</td>";
                                                echo "<td style='text-align: justify;'>".$row['descripcion']." ".$row['apellido']."</td>";
                                                echo "<td><input class='case4' name='".$row['idFormulario']."-plataforma' value='".$row['idFormulario']."-plataforma' type='checkbox' ".$checkListar."></td>";
                                              //  echo "<td><input name='".$row['idFormulario']."-correo' value='".$row['idFormulario']."-correo' type='checkbox' ".$checkCrear."></td>";
                                                echo"</tr>";
                                            }
                                        ?>
                    ...
                    <form action="controlador/controllerNotificaciones" method="POST"> 
                        <div class="card">
                          ...
                          <?php
                            ...
                            $acentos = $mysqli->query("SET NAMES 'utf8'");
                            $data = $mysqli->query("SELECT permisosNotificaciones.plataforma, permisosNotificaciones.correo, permisosNotificaciones.formulario, formularios.* FROM formularios INNER JOIN permisosNotificaciones 
                            WHERE formularios.modulo = 'compras' AND permisosNotificaciones.formulario =formularios.idFormulario AND permisosNotificaciones.idGrupo = '$idGrupo' ORDER BY formularios.orden");
                          ?>
                          <div class="card-body">
                                      ...
                                      <tbody>
                                        <?php
                                            while($row = $data->fetch_assoc()){
                                                ...
                                                echo "<td style='text-align: left;'>".$row['nombre']." ".$row['apellido']."</td>";
                                                echo "<td style='text-align: justify;'>".$row['descripcion']." ".$row['apellido']."</td>";
                                                echo "<td><input class='case5' name='".$row['idFormulario']."-plataforma' value='".$row['idFormulario']."-plataforma' type='checkbox' ".$checkListar."></td>";
                                              //  echo "<td><input name='".$row['idFormulario']."-correo' value='".$row['idFormulario']."-correo' type='checkbox' ".$checkCrear."></td>";
                                                echo"</tr>";
                                            }
                                        ?>
