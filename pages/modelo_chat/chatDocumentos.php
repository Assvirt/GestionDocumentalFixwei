...
<div class="container">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title" style="font-family:Source Sans Pro,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol;">Cargar archivos</h3>
      </div>
	...
	<div class="file_upload">
		<form action="documentos/file_upload.php" class="dropzone">
			...
			<div class="dz-message needsclick">
				<strong style="font-family:Source Sans Pro,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol;">Arrastra archivos a cualquier lugar para subirlos.</strong><br /><br />
