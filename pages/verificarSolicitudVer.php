            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-6">
                             <div class="col-sm-6">
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="verificarSolicitud"><font color="white"><i class="fas fa-list"></i> Listar</font></a></button>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <form action="verificarSolicitudDocumentos"  method="post">
                        ...
                        <div class="col-sm-3">
                            <form action="verificarSolicitudFactura"  method="post"><!--registroValores-->
                            <input name="idOrdenCompra" value="<?php echo $_POST['idOrdenCompra'];?>" type="hidden">
