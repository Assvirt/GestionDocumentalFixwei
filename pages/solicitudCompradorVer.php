                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="solicitudComprador"><font color="white"><i class="fas fa-list"></i> Listar solicitud de compra</font></a></button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <form action="registroProductosVisualizar"  method="post">
                                ...
                                <input name="comprador" value="1" type="hidden">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input name="idOrdenCompra" value="<?php echo $_POST['idOrdenCompra'];?>" type="hidden">
                            <button type="submit"  class='btn btn-success  btn-sm' id="" ><i class="fas fa-file-invoice-dollar"></i> Generar Orden de Compra</button>
                            </form>
                         </div>
                    </div>
                </div>
