  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar Formulas y Variables <?php $quienCrea=$_POST['quienCrea'];?></h1> 
          </div>
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    ...
                    $variablesIdPrincipal=$_POST['variablesIdPrincipal'];
                                ...
                                ?>
                    <h3 class="card-title">Agregar Formulas y Variables para <b><?php echo $nombreIndicador; ?></b></h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                        <div class="form-group col-sm-6">
                            <form action="controlador/indicadores/controllerM" method="POST">
                                    ...
                                    Multiserie
                                    <input type="radio" class=""  name="variables" value="Multiserie" required>
                                    <br>
                                    <button type="submit" style="color:white;" class="btn btn-info" name="AplicarVariableUnicaMulti">Aplicar</button>
