<?php
	...
	INNER JOIN tipoDocumento WHERE proceso = '$idCedi' AND documento.tipo_documento = tipoDocumento.id AND documento.vigente = 1 AND pre IS NULL group by tipoDocumento.id order by documento.nombres ASC ");  
