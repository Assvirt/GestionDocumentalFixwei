...
header('Content-Disposition: attachment; filename=OrdenDeCompraEjecutados.xls');
                        ...
                        echo '<td>';
                            ...
                            <tr>
                                <th>
                                    ...
                                    <br>
                                    &nbsp<b> Ciudad:&nbsp;</b>
                                    <?php utf8_decode($extraerDatosConsultaProveedor['ciudad']); ?>
                                    <?php 
                                    ...
                                    echo $nombreDepartamento = utf8_decode($rowCiudad['Departamento']).'-';
                                    echo $codigoCiud = utf8_decode($rowCiudad['Municipio']);
                                           ...
                                           while($extraerConsulta = mysqli_fetch_array($consultaProductos)){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php 
                                                    ...
                                                    echo utf8_decode($extraerProductos['nombre']);
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    ...
                                                    echo utf8_decode($traerDAtosconsultaidentificadorProducto['grupo']);
                                                    ?>
                                                </td>
                                                 <td>
                                                    <?php
                                                     echo utf8_decode($extraerProductos['codigo']);
                                                    ?>
                                                </td>
                                                <td><?php 
