...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Editar Pol&iacute;ticas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Editar Pol&iacute;ticas</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Editar pol&iacute;ticas</li>
            </ol>
          </div>
        </div>
        <div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              $aprobador=$imprimirDatos['aprobador'];
                ...
                <!-- Fin parametros para la activacion de correo y plataforma -->
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="number" class="form-control" min='<?php echo $minimo;?>' value="<?php echo $minimo; ?>" name="minimo" placeholder="Monto m&iacute;nimo" required>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Monto m&iacute;nimo ($):</label>
                            <input type="number" class="form-control" min='<?php echo $maximo;?>' value="<?php echo $maximo; ?>" name="maximo" placeholder="Monto m&aacute;ximo" required>
                        </div>                        
                    </div>
    ...
    $(document).ready(function(){
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            var rad_post = document.getElementById("idPoliticas").value;
            var grupo = radios[i].value;
            var radEncargado = "radEncargado";

            $.post("selectDocumentosEditar3.php", { rad_post: rad_post, grupo: grupo, radEncargado: radEncargado}, function(data){
                $("#select_encargadoE").html(data);
            }); 
