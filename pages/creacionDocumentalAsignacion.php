      ...
      <div class="container-fluid">
        ...
        <div>
            ...
            <div class="col-sm">
                ...
                <button type="button" class="btn btn-block btn-info btn-sm"><a href="creacionDocumental"><font color="white"><i class="fas fa-list"></i> Listar creación documental</font></a></button>
                ...
                <table class="table table-head-fixed text-center" id="example">
                  <thead>
                    <tr>
                      ...
                      <th>Proceso</th>
                      <th>Estado</th>
                      <th style="display:<?php echo$visibleE;?>;">Ver</th><!--Si tiene permiso de editar se muestra la columna editar -->
                      <th>Plantilla</th>
                    </tr>
                  </thead>
                  <tbody>
                 ...
                 /// si el documento no ha sido asignado, es decir, está sin definir, no debe mostrar
                    if($version == '<strong>Sin definir</strong>'){
                     ...
                     echo"<form action='creacionDocumentalAsignacionVer' method='POST'>";
                            echo"<td>";
