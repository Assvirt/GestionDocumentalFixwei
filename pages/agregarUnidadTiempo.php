...
<!DOCTYPE html>
<html>
    <title>Agregar Tiempo de Servicio</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar Tiempo de servicio</li>
             </ol>
          </div>
        </div>
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="agregarProveedorProducto"><font color="white"><i class="fas fa-list"></i> Agregar productos</font></a></button>
                        </div>
                         <div class="col-sm-3">
        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php 
                    $query = $mysqli->query("SELECT * FROM proveedoresProductoTiempo WHERE id = '$idProveedorGrupo'");
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='agregarUnidadTiempo'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM proveedoresProductoTiempo order by grupo")or die(mysqli_error());
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/proveedor/controllerProductoTiempo' method='POST'>
...
$validacionExisteImportacionImpuesto=$_POST['validacionExisteImportacionImpuesto'];
?>
<script type="text/javascript">
  $(function() {
    ...
    if($validacionExisteImportacionImpuesto == 1){
    ?>
        Toast.fire({
            type: 'warning',
            title: ' El impuesto no existe en el sistema.'
        })
    <?php
    }
    ...
    ?>
        Toast.fire({
            type: 'warning',
            title: ' Algunos de los identificadores ya existen.'
        })
    <?php
    }
    ...
    ?>
        Toast.fire({
            type: 'warning',
            title: ' Algunos identificadores están repetidos en el documento.'
        })
    <?php
    }
    ...
    ?>
        Toast.fire({
            type: 'warning',
            title: ' Algunos nombres ya existen.'
        })
    <?php
    }
    ...
    ?>
        Toast.fire({
            type: 'warning',
            title: ' El tiempo de servicio  ya existe.'
        })
    <?php
    }
