...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <title>FIXWEI - Editar encabezado</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Editar encabezado</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Editar encabezado</li>
            </ol>
          </div>
        </div>
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="crearEncabezadoLista"><font color="white"><i class="fas fa-list"></i> Listar Encabezado</font></a></button>
                        </div>
                    </div>
                </div>
                <div class="col">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- form start -->
                ...
                <form  action="controlador/actas/encabezado" method="POST" role="form" enctype="multipart/form-data" enctype="multipart/form-data">  
                <div class="card-body">
                  <?php
                    require_once 'conexion/bd.php';
                    $id=$_POST['id'];
                    $queryEncabezado = $mysqli->query("SELECT * FROM encabezado WHERE id = '$id'");
                    $encabezado = $queryEncabezado->fetch_array(MYSQLI_ASSOC);
                  ?>
                  <div class="form-group">
                    <label>Desarrollo del encabezado: </label><br>
                    <p>
                ...
                <div class="card-footer" >
                  <button type="submit" name="encabezado" class="btn btn-primary float-right">Actualizar</button>
                </div>
              </form>
...
<script src="ckeditorEditor.js"></script>
 -->
