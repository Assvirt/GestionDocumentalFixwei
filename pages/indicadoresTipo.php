...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Agregar Tipo de Indicadores</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar Tipo de Indicadores</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar Tipo de Indicadores</li>
            </ol>
          </div>
        </div>
        <div>
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <?php 
                    ...
                    $query = $mysqli->query("SELECT * FROM indicadoresTipo WHERE id = '$id'");
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='indicadoresTipo'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="controlador/indicadores/controllerTipo" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label>Tipo:</label>
                    <input type="text" class="form-control" id="nombreProceso" name="tipo" placeholder="tipo"onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)"  required>
                    <br>
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $acentos = $mysqli->query("SET NAMES 'utf8'");
                     $data = $mysqli->query("SELECT * FROM indicadoresTipo order by tipo")or die(mysqli_error());
                    ...
                    $id=$row['id'];
                    echo"<form action='indicadoresTipo' method='POST'>";
                    ...
                    echo"</form>";
                    /*
                    echo"<form action='controlador/indicadores/controllerTipo' method='POST'>";
                    echo"<input type='hidden' name='id' value= '$id' >";
                    echo" <td><button onclick='return ConfirmDelete()' type='submit' name='Eliminar' class='btn btn-block btn-danger btn-sm'><i class='fas fa-trash-alt'></i> Eliminar</button></td>";
                    echo"</form>";
                    */
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/indicadores/controllerTipo' method='POST'>
