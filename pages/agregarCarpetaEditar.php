          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                $consultaNombre=$mysqli->query("SELECT * FROM proveedordocumentosCarpetas WHERE id='". $_POST['idCarpeta']."' ");
                $extraerNombreCarpeta=$consultaNombre->fetch_array(MYSQLI_ASSOC);
