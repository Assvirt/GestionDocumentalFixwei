...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Agregar Tipo de proveedor</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar Tipo de proveedor</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar Tipo de proveedor</li>
            </ol>
          </div>
        </div>
        <div>
        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php 
                    $query = $mysqli->query("SELECT * FROM proveedoresTipo WHERE id = '$idProveedorGrupo'");
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='agregarProveedoresTipo'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM proveedoresTipo order by tipo")or die(mysqli_error());
                    ...
                    $id=$row['id'];
                    echo"<form action='agregarProveedoresTipo' method='POST'>";
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/proveedor/controllerTipo' method='POST'>
...
<script type="text/javascript">
  $(function() {
    ...
    ?>
        Toast.fire({
            type: 'warning',
            title: ' El tipo de proveedor  ya existe.'
        })
    <?php
    }
