...
<!DOCTYPE html>
<html>
    <title>Orden de Compra Ejecutadas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Orden de Compra Ejecutadas</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Solicitud de compra Ejecutadas</li>
            </ol>
          </div>
        </div>
        <div>
                ...
                <?php
                    ...
                    while($row = $data->fetch_assoc()){
                         ...
                         if($extraerDatos['idUsuario'] == $idparaChat){
                             $habilitarDescargar='activo'; 
                         }else{
                             $habilitarDescargar='';   
                         }
                    }
                    
                if($habilitarDescargar == 'activo' ){
                ?>
               </div>
               <div class="col-sm">
                <form action="exportacion/ordenCompraEjecutadas" method="post">
                ...
                ?>
                <form action="exportacion/ordenCompraEjecutadasT" method="post">
                    <button type="submit" class="btn btn-block btn-warning btn-sm" ><a href="#"><font color="white"><i class="fas fa-download"></i> Exportar Todo</font></a></button>
                </form>
                <?php
                }
                ?>
                  ...
                  <tbody>
                     ...
                     while($row = $data->fetch_assoc()){
                         ...
                         if($extraerDatos['idUsuario'] == $idparaChat){
                            ...
                            $fechaActivada=$extraerDatos['fechaActivada'];
                         }else{
                           continue;  
                         }
                    ...
                    //echo "<td> $ ".number_format($totalEjecutado)."</td>";
