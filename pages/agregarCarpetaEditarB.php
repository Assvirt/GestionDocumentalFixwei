        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <?php
                    ...
                    $query = $mysqli->query("SELECT * FROM carpeta WHERE id= '$idProveedor'");
