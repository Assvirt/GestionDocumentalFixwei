                      ...
                      <div class="card-body">
                        <div class="">
                                                                ...
                                                                <tr>
                                                                      ...
                                                                      <!--  <td style="display:< ?php echo $accionesResponsable;?>;">
                                                                       ...
                                                                       <!-- <td colspan="2" style="display:< ?php echo $accionesResponsable;?>;">
                                                                        ...
                                                                        <?php
                                                                        if($comparaIDUsuario == $idparaChat && $estadoCompromiso == 'Pendiente' || $comparaIDUsuario == $idparaChat && $estadoCompromiso == 'Avance' || $comparaIDUsuario == $idparaChat && $estadoCompromiso == 'Rechazado' || $enviarIdUsuarioEntrega == $idparaChat && $estadoCompromiso == 'Ejecutado'){
                                                                        ?>
                                                                       <!-- <td><button class="btn btn-primary btn-sm " type="submit" name="compromisoIndividual"><i class='fas fa-sync'></i> Actualizar</button></td>-->
                                                                        <?php
                                                                        }else{
                                                                        ?>
                                                                        <!--<td><button class="btn btn-primary btn-sm " disabled><i class='fas fa-sync'></i> Actualizar</button></td>-->
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                ...
                                                                <tr>
                                                                    <form action="controlador/actas/controller" method="POST" enctype="multipart/form-data">
                                                                       ...
                                                                       <!-- <td colspan="2" style="display:< ?php echo $accionesResponsable;?>;">
                                                                        ...
                                                                        <?php
                                                                        if($enviarIdCargo == $cargo && $estadoCompromiso == 'Pendiente' || $enviarIdCargo == $cargo && $estadoCompromiso == 'Avance' || $enviarIdCargo == $cargo && $estadoCompromiso == 'Rechazado' || $enviarCargoEntrega == $cargo && $estadoCompromiso == 'Ejecutado'){
                                                                        ?>
                                                                        <!--<td><button class="btn btn-primary btn-sm" type="submit" name="compromisoIndividual"><i class='fas fa-sync'></i> Actualizar</button></td>-->
                                                                        <?php
                                                                        }else{
                            ...
                            <form action="controlador/actas/controller" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Control de cambio: </label>
                                        <textarea class="form-control" name="controlCambio"></textarea>
                                        <br>
                                        <input type="hidden" name="idCompromiso" value="<?php echo $idCompromiso;?>">
                                        <input type="hidden" name="idActa" value="<?php echo $idActa;?>">
                                        <input type="hidden" name="estado" value="<?php echo $estado;?>">
                                        <button class="btn btn-primary float-right" type="submit" name="estadoCompromiso">Actualizar control de cambio.</button>
