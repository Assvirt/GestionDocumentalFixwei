      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <form role="form" id="formCrearDoc" action="crearDocumentoB2" onsubmit="event.preventDefault(); sendForm();" method="POST">      
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Nombre del documento: </label>
                            <input type="text" class="form-control" name="nombreDocumento" placeholder="<?php echo $traerNombreSolicitud['nombreDocumento2'];?>" value="<?php echo $traerNombreSolicitud['nombreDocumento2'];?>" required>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Proceso:</label>
                            <?php
                                ...
                                $resultado=$mysqli->query("SELECT * FROM procesos WHERE id='".$traerNombreSolicitud['proceso']."' ORDER BY nombre");
                            ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="custom-control custom-radio">
                              <input class="custom-control-input" type="radio" id="customRadio1" name="rad_metodo" value="documento" required>
                    ...
                    <label>Flujo usuarios:</label>&nbsp;&nbsp;
                        Activos
                            <input type="radio" id="usuariosActivos" value="activosUsuarios" name="validandoUsuarios" checked required>
                            &nbsp;&nbsp;
                        Retirados
                            <input type="radio" id="usuariosRetirados" value="retiradosUsuarios" name="validandoUsuarios" required>
                            
                    <!-- tenemos los usuarios retirados--------------------------------------------------------------    -->
                    <div class="row" id="mostrarRetirados" style="display:none;">
                        <div class="form-group col-sm-6">
                            <label>Quién elabora: </label><br>
                            <input type="hidden"  name="radiobtnE" value="cargos" required>
                            <div class="select2-blue">
                                <input class="form-control" name="select_encargadoE" type="text" pattern="[A-Za-z0-9_- ]{1,90}"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="select2-blue">
                                <input class="form-control"  name="select_encargadoR" type="text" pattern="[A-Za-z0-9_- ]{1,90}"  >
                            </div>
                        </div>
                    ...
                    <div class="row" id="mostrarActivos">
                        <div class="form-group col-sm-6">
                            <label>Quién elabora: </label><br>
                    ...
                    <div class="row">
                        ...
                        <!-- tenemos los usuarios retirados--------------------------------------------------------------    -->
                        <div class="form-group col-sm-6" id="mostrarRetiradosB" style="display:none;">
                            <label>Quién aprueba: </label><br>
                            <input type="hidden" name="radiobtnA" value="cargos" required>
                            <div class="select2-blue">
                                <input class="form-control" name="select_encargadoA" type="text" pattern="[A-Za-z0-9_- ]{1,90}" >
                            </div>
                        </div>
                        <!-- tenemos los usuarios retirados--------------------------------------------------------------    -->
                        
                        <!-- tenemos los usuarios activos--------------------------------------------------------------    -->
                        <div class="form-group col-sm-6" id="mostrarActivosB">
                            <label>Quién aprueba: </label><br>
                            ...
                            <div id="codificacionManual" style="display:;"> <!-- none -->
                                <div class="form-group col-sm-6">
                                    <div class="form-group col-sm-3">
                                        <label>Versión: </label>
                                        <input name="versionDeclarada" id="id_version" type="number" min="1">
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label>Consecutivo: </label>
                                        <input name="consecutivoDeclarado" id="consecutivo" type="number" min="1">
                                    </div>
                                </div>
                            </div>
