        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar Cargos</li>
            </ol>
          </div>
        </div>
        <div>
              ...
              <form  action="controlador/cargos/controladorCargos" method="POST" role="form">
                ...
                <!-- Fin parametros para la activacion de correo y plataforma -->
                  ...
                  <div class="form-group">
                    ...
                    <?php
                        $acentos = $mysqli->query("SET NAMES 'utf8'");
                        $query = "SELECT * FROM nivelcargo ORDER BY id";
						$resultado=$mysqli->query($query);
                      ?>
                      <p><b>Nivel del cargo</b></p>
                ...
                <div class="card-footer" >
                  <button type="submit" name="AgregarCargos"  class="btn btn-primary float-right">Agregar</button>
                </div>
              </form>
            </div>
            </div>    
