...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Agregar Presupuesto</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
             <h1 class="card-title">Agregar presupuesto</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar presupuesto</li>
            </ol>
          </div>
        </div>
        <div>
                ...
                <!-- Fin parametros para la activacion de correo y plataforma -->
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                <label>Responsable del presupuesto: </label><br>
                                   ...
                                   <select class="form-control" type="text" name="select_encargadoE" required>
                                      <option value=""></option>
                                      	<?php 
                                      	...
                                      	while ($columna = $consultausuarios->fetch_array()) { 
                                      	    ...
                                      	    $centroCostoValidar=$mysqli->query("SELECT * FROM centroCostos WHERE persona='".$columna['id']."' ");
                                      	...
                                      	?>
                                      <option class="form-control" value="<?php echo $columna['id']; ?>"><?php echo  $extraerCentrCosto['codigo'].' - '.$extraerCentrCosto['prefijo'].' - '.$extraerCentrCosto['nombre'].'  Responsable ('.$columna['nombres'].' '.$columna['apellidos'].')'; ?> </option>
                                      <?php } ?>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" min='1' id="Costo" name="valor" placeholder="Valor total del presupuesto"  required>
                             $<span id="total" ></span></b>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Periodo del presupuesto (Año)</label>
                            <input type="text" class="form-control" min='1' name="periodo" placeholder="Periodo del presupuesto" required>
                        </div>                        
                    </div>
                  ...
                  <script type="text/javascript" >
                        ...
                        $("#Costo").keyup(function () {
                                var value = $(this).val();
                                var pesos = new Intl.NumberFormat().format(value);
                                document.getElementById('total').innerHTML = pesos;
                            });
                        });
