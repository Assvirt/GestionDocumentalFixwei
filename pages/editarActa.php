 ...
 <script>
    ...
    <section class="content">
        <div class="container-fluid">
                <div class="row">
                    <div class="col"></div>
                  <form action="compromiso" method="POST" onsubmit="return checkSubmit();">
