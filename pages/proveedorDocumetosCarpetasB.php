    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div>
            ...
            ?>
            <div class="col-sm">
                 <form action="agregarProveedorDocumentoB" method="post">
            ...
            if($realizador == $idparaChat){
                ...
                $validandoDocumento=$mysqli->query("SELECT * FROM carpeta WHERE rol='".$_POST['idProveedor']."'  ORDER BY nombre ASC")or die(mysqli_error()); //AND fila='1'
                $contadorArchivosExistentes=0;
                while($extraerValidaciónDocumentos=$validandoDocumento->fetch_array()){
                    ...
                    if($extraerValidaciónDocumentosArchivos['id'] != NULL){
                        $contadorArchivosExistentes++;        
                    }
                }
                
                
                if($contadorArchivosExistentes > 0){
            ?>
                    <div class="col-sm">
                ...
                <div class="card-header">
                    <form action="controlador/proveedor/controllerDocumento" method="post"> 
                        ...
                        ?>            
                                <div class="card-header">
                                    <label>Comentario</label>
                                    <textarea  name="comentario" class="form-control" onkeypress="return ( (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 46 ||  event.charCode == 44 || event.charCode == 58 || event.charCode == 59 || event.charCode == 13 || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 ||  event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218 || (event.charCode >= 48 && event.charCode <= 57) )" required></textarea>
                                    <br>
      ...
      <div class="container-fluid">
        ...
        <div>
            ...
            ?>
                ...
                ?>
                <div class="col-sm">
                <form action="agregarCarpetaB" method="POST">
                    <input name="idProveedor" value="<?php echo $idProveedor; ?>" type="hidden" readonly>
              ...
              <div class="card-body table-responsive p-0" >
                <table class="table table-head-fixed ">
                  ...
                  <tr>
                    ...
                    <td>
                            <form action="agregarCarpetaEditarB" method="POST">
                                <input name="idProveedor" value="<?php echo $_POST['idProveedor']; ?>" type="hidden" readonly>
                                <input name="idDestino" value="<?php echo $rowDestino['id']; ?>" type="hidden" readonly>
                                 <button type="submit" name="Update" class="btn btn-block btn-success btn-sm"><i class="fas fa-edit"></i> Editar</button>
                            </form>
