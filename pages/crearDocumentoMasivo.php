...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Crear documento vigente</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Crear Documento Vigente</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Crear documento Vigente</li>
            </ol>
          </div>
        </div>
        <div class="row">
            ...
            <div class="col-9">
                <div class="row">
                    ...
                    ?>
                    <button type="button" class="btn btn-block btn-info btn-sm"><a href="crearDocumentoMasivo"><font color="white"><i class="fas fa-list"></i> Listar </font></a></button>
                    <?php
                        
                    }else{
                    ?>
                    <button type="button" class="btn btn-block btn-info btn-sm"><a href="creacionDocumental"><font color="white"><i class="fas fa-list"></i> Listar </font></a></button>
                    <?php
                    }
                    ?>
                    </div>
            ...
            <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-head-fixed text-center" id="example">
                            ...
                            <tbody>
                                <?php
                                $consultandoDocumentosMasivos=$mysqli->query("SELECT * FROM documento WHERE pre='si' AND obsoleto='0' AND vigente='1' ORDER BY id");
                                $conteo='1';
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content bg-danger">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?php
                                    $consulta_documento=$mysqli->query("SELECT * FROM documento WHERE vigente='1' AND pre='si' ");
...
<?php
    ...
    if(isset($_POST['editarDocumentoMasivo'])){ 
        ...
        if($extraerConsultaDatosDocumento['vigente'] == '1' && $extraerConsultaDatosDocumento['pre'] == NULL){
        ?>
                        <script> 
...
?>
 ...
 <form role="form" id="formCrearDoc" action="controlador/solicitudDocumentos/pruebaAlmacenamiento" method="POST" onsubmit="sendForm(); event.preventDefault(); " enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input autocomplete="off" type="text" class="form-control" name="nombreDocumento" placeholder="<?php echo $extraerConsultaDatosDocumento['nombres']; ?>" value="<?php echo $extraerConsultaDatosDocumento['nombres'];?>" onkeypress="return ( (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)" required>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Proceso: </label>
                                    ...
                                    <table class="">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                <input class="form-control" name="versionDeclarada" value="<?php echo $extraerConsultaDatosDocumento['versionTemporal']; ?>"  type="number" min="0" required  id="id_version" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                                                </th>
                                                <th>
                                                <label>Consecutivo: </label>
                                                </th>
                                                <th>
                                                <input class="form-control" name="consecutivoDeclarado" value="<?php echo $extraerConsultaDatosDocumento['consecutivoTemporal']; ?>" type="number" min="0" required id="consecutivo" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)"> 
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
               ...
               <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input autocomplete="off" value="<?php echo $enviarInformacionCcontrolCambios; ?>" class="form-control" name="controlCambios" placeholder="Comentarios..." onkeypress="return ( event.charCode >= 58 || event.charCode >= 58 || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            <br>
                            ...
                            <input autocomplete="off" class="form-control" value="<?php echo $enviarInformacionCcontrolCambiosB;?>" name="comentarioRevision" placeholder="Comentarios..." onkeypress="return ( event.charCode >= 58 || event.charCode >= 58 || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            <br>
                            ...
                            <input autocomplete="off" class="form-control" value="<?php echo $enviarInformacionCcontrolCambiosC; ?>" name="comentarioAprobo" placeholder="Comentarios..." onkeypress="return ( event.charCode >= 58 || event.charCode >= 58 || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            <br>
                            <!--
              ...
              $consultandoDocumentoPreguntaListadoMaestro=$mysqli->query("SELECT * FROM documento WHERE id='".$_POST['enviarIdDocumento']."' AND vigente='1' AND pre IS NULL ");
              ...
              ?>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content bg-danger">
                                <div class="modal-body">
                                  <center>
                                    <p>El documento ya fue gestionado.
                                    </p>
                   ...
                   <span Onclick="window.location.href='crearDocumentoMasivo'" class="btn btn-success float-left" >Cerrar</span>     
              <?php
              }else{
              ?>
                    <span Onclick="window.location.href='crearDocumentoMasivo'" class="btn btn-success float-left" >Cerrar</span>
...
?>  <!--  -->
    <form  role="form" id="formCrearDoc" action="controlador/solicitudDocumentos/pruebaAlmacenamiento" onsubmit="sendForm();  event.preventDefault(); " method="POST" enctype="multipart/form-data">
    <!-- Main content -->
    <section class="content">
      <div class="container-fluid">
        <!-- /.row -->
               ...
               -->
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Nombre del documento: </label> <!--  este es el mismo nombre que se debe enviar el la solicitud de documento-->
                            <input autocomplete="off" type="text" class="form-control" name="nombreDocumento" placeholder="<?php echo $traerNombreSolicitud['nombreDocumento2'];?>" value="<?php echo $traerNombreSolicitud['nombreDocumento2'];?>" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)" required>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Proceso: </label>
                            <!--
               ...
               <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input autocomplete="off" class="form-control" name="controlCambios" placeholder="Comentario del elaborador..." onkeypress="return (event.charCode == 58 || event.charCode == 59 || event.charCode == 13 || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            <br>
                            <label>Fecha de revisión: </label>
                            ...
                            <input autocomplete="off" class="form-control" name="comentarioRevision" placeholder="Comentario del revisor..." onkeypress="return (event.charCode == 58 || event.charCode == 59 || event.charCode == 13 || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            <br>
                            ...
                            <div class="input-group" style="width:;">
                                    ...
                                    <input type="date" id="terceraFecha" name="fechaAprobacion" class="form-control float-right"  max="9999-12-31"required> <!-- reservationtime-->
                                    <!-- este input es para mostrar la fecha sin dejarse modificar después de validar las fechas -->
                                        <input style="display:none;" type="date" id="mostrarSTercerFecha"  class="form-control float-right"  max="9999-12-31"  required>
                                    <!-- END -->
                            </div>
                            
                            <input autocomplete="off" class="form-control" name="comentarioAprobo" placeholder="Comentario del aprobador..." onkeypress="return (event.charCode == 58 || event.charCode == 59 || event.charCode == 13 || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            <br>
                            <!--
                            <label>Control de cambios: </label>
                            <textarea rows="2" class="form-control" name="controlCambios" placeholder="Control de cambios" required></textarea>
                    ...
                    <input name="agregarDocB" value="1" type="hidden">
                                ...
                                <script>
                                   /// validamos si la fecha está bien digitada o no
                                    function funcionFormula(){ 
                                       //// capturamos las variables de las fechas
                                       fechaAprobacionPrimera = document.getElementById("primerafecha").value; // elaborador
                                       fechaAprobacionSegunda = document.getElementById("segundafecha").value; // revisor
                                       fechaAprobacion = document.getElementById("terceraFecha").value; // aprobador
                                       //// END
...
function sendForm(){
    ...
    var valido = '';
    /*
    alert('Proceso ' + idProceso);
    alert('tipo de documento ' + idTipoDocumento);
    alert('consecutivo ' + consecutivo);
    alert('version ' + id_version);
    alert('id documento ' + idDocumento);
    */
    $.post("validaVersionamientoB.php", { consecutivo: consecutivo, idProceso: idProceso, idTipoDocumento: idTipoDocumento, idDocumento : idDocumento, id_version : id_version }, function(data){
        valido = data;
        ...
        if(valido == "si"){
            ...
            Toast.fire({
            type: 'warning',
            title: ' El consecutivo ya existe.'
            })
        	return false;
        }else{
