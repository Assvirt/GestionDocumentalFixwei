      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h6>Este grupo est&aacute; asociado a los siguientes Sub-grupos, est&aacute; seguro de eliminar el grupo junto con los sub-grupos ?</h6>
          </div>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-2">
                            <form action="controlador/presupuesto/controllerPrespuestoGestionGC" method="POST">
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE idPresupesto='$idPresupuesto' AND modulo='subgrupo' AND grupo='$idGrupos'  ORDER BY nombreGC ASC")or die(mysqli_error());
