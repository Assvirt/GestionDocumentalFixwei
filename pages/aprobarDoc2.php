      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="aprobarDoc3" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            ?>
                            <button type='button'  class='btn btn-block btn-warning btn-sm  <?php echo $disabledPDF;?>'>
                                <a style='color:black' href='<?php echo $rutaPDF;?>' download='<?php echo $rutaPDF; ?>'><i class='fas fa-download'></i> Descargar</a>
                            </button>
                            <?php
                            }
                            ?>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            ?>
                            <button type='button'  class='btn btn-block btn-warning btn-sm <?php echo $disabledOtro;?>' >
                                <a style='color:black' href='<?php echo $rutaOtro;?>' download='<?php echo $rutaOtro; ?>' ><i class='fas fa-download'></i> Descargar</a>
                            </button>
                            <?php
                            }
                            ?>
