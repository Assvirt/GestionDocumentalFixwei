...
if(!empty($_FILES)){
    ...
    if(move_uploaded_file($_FILES['file']['tmp_name'],$uploaded_file)){
        ...
        $mysql_insert = "INSERT INTO chat (documento,sender_userid,reciever_userid,message,timestamp,status,nombreDocumento)VALUES('".$concatenar."','".$_POST['idEnvia']."','".$_POST['idRecibe']."','documento','".date("Y-m-d H:i:s")."','1','$fileName')";
