        ...
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <form action="proveedorDocumetosInscripcion" method="POST">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="controlador/proveedor/controllerDocumentoInscripcion" method="POST" enctype="multipart/form-data">
                <div class="card-body">
