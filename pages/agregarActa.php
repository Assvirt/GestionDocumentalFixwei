        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Crear Actas</li>
            </ol>
          </div>
        </div>
                  ...
                  <form role="form" action="controlador/actas/controller" method="POST">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" placeholder="Nombre acta">
                      </div>
                      <div class="form-group">
                        <label>Proceso:</label>
            ...
            <?php }else{ ?>
                  ...
                  <!-- se agrega otro modelo de agregar varios formularios -->
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="compromisos" placeholder="compromiso">
                      </div>
                        <div class="form-group col-sm-6">
                                                    ...
                                                    // Crear un elemento div añadiendo estilos CSS
                                                            ...
                                                            $('#btAdd2').click(function() {
                                                                if (iCnt <= 4) {
                                                                    ...
                                                                    $(container).append('<div class="form-group"><label for="">Compromiso/Tareas</label><input type="text" class="form-control" name="compromisos'+ iCnt + '" id=tb' + iCnt + ' ' + ' placeholder="compromiso"></div><div class="form-group col-sm-6"><label>Responsable: </label><br><input type="radio" id="rad_cargoRes'+ iCnt + '" name="rad_Res'+ iCnt + '" id=tb' + iCnt + ' ' + ' value="cargo"><label for="cargo">Cargo</label><input type="radio" id="rad_usuarioRes'+ iCnt + '" name="rad_Res'+ iCnt + '" id=tb' + iCnt + ' ' + ' value="usuario"><label for="usuarios">Usuarios</label><div class="select2-blue"><select class="select2" multiple="" data-placeholder="Seleccionar encargado" style="width: 100%;" name="select_encargadoRes'+ iCnt + '[]" id=select_encargadoRes' + iCnt + ' ' + '  required></select></div></div>');
                ...
                <div class="card-footer" >
                  <button type="submit" name="agregarActa" class="btn btn-primary float-right">Submit</button>
                </div>
              </form>
            </div>
            </div>    
