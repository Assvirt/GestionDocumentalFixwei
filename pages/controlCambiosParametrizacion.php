...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Control de Cambios</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h6>Establezca el diseño para el registro del control de cambios documental.</h6><br>
          </div>
              ...
              <!-- /.card-header -->
               <div class="card-body">
                  <div class="form-group">
                    ...
                    <br><br>
                <form  action="controlador/controlCambiosParametrizacion" method="POST" role="form">
                        <div class="form-group ">
                            <?php
                            ...
                            // end
                            ?>
                            <textarea name="editor1" required><?php echo $extraerControlCambios['informacion'];?></textarea>
                        </div>
                  </div>
                ...
                <div class="card-footer" >
                  <button type="submit" name="encabezadoCrear"  class="btn btn-primary float-right">Actualizar</button>
                </div>
              </form>
            </div>
            </div>  
