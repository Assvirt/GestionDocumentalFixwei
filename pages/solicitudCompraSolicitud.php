...
<head><meta charset="gb18030">
  ...
  <title>FIXWEI - Agregar tipo de solicitud</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar tipo de solicitud</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar tipo de solicitud</li>
            </ol>
          </div>
        </div>
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="solicitudCompra"><font color="white"><i class="fas fa-list"></i> Listar tipo de solicitud</font></a></button>
                        </div>
                    </div>
                </div>
                <div class="col">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <?php 
                    ...
                    $query = $mysqli->query("SELECT * FROM solicitudCompraSolicitud WHERE id = '$idNivelCargo'");
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='solicitudCompraSolicitud'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="controlador/solicitudCompra/controllerSolicitudCompraSolicitud" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label>Tipo de solicitud:</label>
                    <input type="text" class="form-control" id="nombreProceso" name="tipo" placeholder="Tipo de solicitud" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)" required>
                  </div>
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $acentos = $mysqli->query("SET NAMES 'utf8'");
                     $data = $mysqli->query("SELECT * FROM solicitudCompraSolicitud order by tipo")or die(mysqli_error());
                     while($row = $data->fetch_assoc()){
                 
                    echo"<tr>";
                    echo" <td>".$row['tipo']."</td>";
                    $id=$row['id'];
                    echo"<form action='solicitudCompraSolicitud' method='POST'>";
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/solicitudCompra/controllerSolicitudCompraSolicitud' method='POST'>
