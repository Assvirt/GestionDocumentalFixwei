...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - PENDIENTES SOLICITUD DOCUMENTAL</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pendientes solicitud documental</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Pendientes solicitud documental</li>
            </ol>
          </div>
        </div>
            <div class="row">
                    ...
                    <!-- Default box -->
                        ...
                        <div class="card">
                          <div class="card-header">
                              ...
                              ?>
                            <h3 class="card-title">Solicitudes documentales pendientes del usuario <?php echo $extraer_consulta_usuario['nombres'].' '.$extraer_consulta_usuario['apellidos'];?></h3>
                            <br>
                            <form action="solicitudDocumentosAsignacion" method="post" target="_blank">
                                <input name="consultaUsario" value="<?php echo $extraer_consulta_usuario['id'];?>" type="hidden">
                                <button type="submit" name="asignacionEntrante" class="btn btn-block btn-info btn-sm" style="width:20%;"><font color="white"> Asignar</font></button>
                            </form>
                                ...
                                <table class="table table-head-fixed text-center" id="example">
                                  ...
                                  <tbody>
                                     <?php
                                        ...
                                        $data = $mysqli->query("SELECT * FROM solicitudDocumentos WHERE encargadoAprobar='".$extraer_consulta_usuario['cargo']."' AND QuienAprueba='".$extraer_consulta_usuario['cedula']."'")or die(mysqli_error()); //WHERE estado = 'Aprobado' OR estado IS NULL
