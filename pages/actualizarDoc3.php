    ...
    if(!file_exists('archivos/documentos/')){
    	...
    	if(move_uploaded_file($rutaPDF, 'archivos/documentos/'.$nombrePDF)){
    	    ...
    	    if($nombrePDF != NULL){ 
                ...
                $validandoDocumentoCaracteresPdf=mb_strtolower($enviarNombrePdf);
    	        ...
    	        if($activarAlertaPdf == FALSE){ 
    	            $idSolicitud = $_POST['idSolicitud'];
                                ...
                                <form name="miformularioPdf" action="actualizarDoc2" method="POST" onsubmit="procesar(this.action);" >
                    	...
                    	$variableDireccion='1';
                                ...
                                <script> 
                                     window.onload=function(){
                                      ...
                                      setTimeout(clickbuttonArchivo, 1000);
                                    function clickbuttonArchivo() { 
                                             document.forms["miformulario"].submit();
                                    }
                                </script>
                                         
                                <form name="miformulario" action="actualizarDoc2" method="POST" onsubmit="procesar(this.action);" >
                                    <input type="hidden" name="idDocumento" id="idDocumento" value="<?php echo $idDocumento ;?>" >
                                    <input type="hidden" name="rol" value="<?php echo $rol;?>"> 
                                    <input type="hidden" name="idSolicitud" value="<?php echo $idSolicitud ;?>" >
                                    <input type="hidden" name="nombreDocumento" value="<?php echo $nombreDoc ;?>" >
    	...
    	if(move_uploaded_file($rutaOtro, 'archivos/documentos/'.$nombreOtro)){
    	    ...
    	    //// realizamos un ingreso del archivo de manera temporal para poder verificar si es un documento bien o mal
        		...
        		if($nombreOtro != NULL){ 
        		    ...
        		    /// volvemos el texto totalmente en minuscula
                $validandoDocumentoCaractereseditable=mb_strtolower($enviarNombreOtro);
                ...
                for ($i=0; $i<strlen($validandoDocumentoCaractereseditable); $i++){
                    if (strpos($descripcion_carecteres, substr($validandoDocumentoCaractereseditable,$i,1))===false){
            		    ...
            		    $idSolicitud = $_POST['idSolicitud'];
                                        ...
                                        <script> 
                                             window.onload=function(){
                                              ...
                                              setTimeout(clickbuttonArchivoEditable, 2000);
                                            function clickbuttonArchivoEditable() { 
                                                     document.forms["miformularioEditable"].submit();
                                            }
                                        </script>
                                                 
                                        <form name="miformularioEditable" action="actualizarDoc2" method="POST" onsubmit="procesar(this.action);" >
                                            <input type="hidden" name="idDocumento" id="idDocumento" value="<?php echo $idDocumento ;?>" >
                                            <input type="hidden" name="rol" value="<?php echo $rol;?>"> 
                                            <input type="hidden" name="idSolicitud" value="<?php echo $idSolicitud ;?>" >
                                            <input type="hidden" name="nombreDocumento" value="<?php echo $nombreDoc ;?>" >
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            if($variableValidado == $datosDoc['asumeFlujo'] && $datosDoc['estadoActualiza'] == null || $datosDoc['estadoActualiza'] == 'Pendiente'){
                ...
                $VariableNoSalir=1; // cuando está en el encargado no debe salir esta opción
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="controlador/documentos/controllerActualizar" method="POST" onsubmit="return checkSubmit();">
                <div class="card-body">
                    <div class="row">
                        <?php
                        ...
                        <div class="col-sm-12">
                            ...
                            // consulta de la tabla del control de cambios
                                ...
                                if($consultandoExistenciaDocumentoActualizar != NULL){  'sii';
                           ...
                           if($títulRol == 'Asignar documento'){
                               'Respaldamos los comentarios anterior';
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <label style="display:none;" id="tituloAprobado"><input style="display:none;" type="radio" id="aprobado" name="radiobtnAprobado" value="aprobado" required> Aprobado</label>
                    ...
                    <label>Códificación</label><br>
                        <?php
                            ...
                            $estadoValidando=$extraerDocumentoValidacion['estadoActualiza'];
