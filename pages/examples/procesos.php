       ...
       <!-- trae la consulta en Java script para la consulta dinamica -->
        	...
        	<html lang="es">
            	<head>
            		...
            		<script src="proceso_peticion.js"></script>
            	</head>
            	<body>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <button type="button" Onclick="window.location='../exportacion/procesos'" class="btn btn-info btn-lg" style="margin-right: 5px;"><i class="fas fa-download"></i>Exportar</button>
                        </td>
                        <td>
                            <a class="btn btn-info btn-lg" href="../importacion/importar-procesos/procesos.xlsx" class="hvr-icon-forward col-3" class="ver" onClick="javascript:document["ver-form"].submit();"><i class="fas fa-download"></i>Descargar Archivo</a>
                        </td>
                        <!--
                        <td><br>
          ...
          <form action="../importacion/importar-procesos/index" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data"><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title"> Agregar nuevo proceso</h4>
                    ...
                    <div class="modal-body">
                      ...
                      <input class="form-control" type="text"  name="dueno" required>
                      ...
                      <p>Es transversal ?:</p>
                      <input class="form-control" type="checkbox"  name="transversal" required>
                      <p>Prefijo:</p>
                      <input class="form-control" type="text"  name="prefijo" required>
                      <p>Orden:</p>
                      <input class="form-control" type="number"  name="orden" required>
                      <p>Macroproceso:</p>
                      <select class="form-control" type="text"  name="macroproceso" required>
                    ...
                    <div class="modal-footer justify-content-between">
                      ...
                      <input type="submit" name="AgregarProceso" class="btn btn-primary" value="Guardar">
                      </form>
                    </div>
                  </div>
                  <!-- /.modal-content -->
