  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Definci&oacute;n</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Defici&oacute;n</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
       ...
       <!-- trae la consulta en Java script para la consulta dinamica -->
        	...
        	<html lang="es">
            	<head>
            		...
            		<script src="definicion_peticion.js"></script>
            	</head>
            	<body>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <button type="button" Onclick="window.location='../exportacion/definicion'" class="btn btn-info btn-lg" style="margin-right: 5px;"><i class="fas fa-download"></i>Exportar</button>
                        </td>
                        <td>
                            <a class="btn btn-info btn-lg" href="../importacion/importar-definicion/definicion.xlsx" class="hvr-icon-forward col-3" class="ver" onClick="javascript:document["ver-form"].submit();"><i class="fas fa-download"></i>Descargar Archivo</a>
                        </td>
                        <!--
                        <td><br>
          ...
          <form action="../importacion/importar-definicion/index" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data"><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title"> Agregar nueva defici&oacute;n</h4>
                    ...
                    <div class="modal-body">
                      ...
                      <textarea class="form-control" type="text"  name="definicion" required></textarea>
                    </div>
                    <div class="modal-footer justify-content-between">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                      <input type="submit" name="AgregarDefinicion" class="btn btn-primary" value="Guardar">
                      </form>
                    </div>
                  </div>
                  <!-- /.modal-content -->
