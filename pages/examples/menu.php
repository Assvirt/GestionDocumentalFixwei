...
?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../controlador/sesion/logout" class="nav-link"><font color="red">Cerrar sesión</font></a>
      </li>
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="home" class="brand-link">
      <img src="../../dist/img/logo3.png"
           alt="AdminLTE Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Fixwei</span>
    </a>

<!-- consulta para traer el usuario que inicia la sesion -->
	<?php 
		$sesion=$_SESSION["session_username"];
		$sesion2=$_SESSION["session_empresa"];
		
		require '../conexion/bd.php';
		$sql= $mysqli->query("SELECT usuario.nomUsuario,usuario.telefono,usuario.cedula,usuario.cargo,usuario.foto,usuario.telefono,usuario.correo,usuario.pais,
		perfiles.nomPerfil,perfiles.cedul,perfiles.ciudad,perfiles.cor,perfiles.clave FROM usuario INNER JOIN perfiles ON
		usuario.cedula = perfiles.cedul AND usuario.cedula='$sesion' AND perfiles.cedul='$sesion' ");
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="admin-pagina" class="nav-link">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                Admin p&aacute;gina
                <i class="right fas fa-angle-left"></i>
