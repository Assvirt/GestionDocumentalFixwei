      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="solicitudRechazada3" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            /// en caso que venga una eliminaicón ocultadmos los campos de archivos
                            if($_POST['solitudElimin'] != NULL){ }else{
                            ?>
                            <br>
                              ...
                              <div class="custom-file">
                                <input type="file" class="custom-file-input <?php echo $disabledOtro;?>" id="miInput2" name="archivootro" accept=".xls,.xlsx,.docx,.doc,.dwg">
                                    ...
                                    $('input[name="archivootro"]').on('change', function(){
                                        var ext = $( this ).val().split('.').pop();
                                        if ($( this ).val() != '') {
                                          if(ext == "xls" || ext == "xlsx" || ext == "docx" || ext == "doc" || ext == "dwg" || ext =="pptx"){
                        ...
                        $consultandoSolicitudDocumentos=$mysqli->query("SELECT * FROM documento WHERE id_solicitud='".$datosDoc['id_solicitud']."' ");
                        $extraerTipoSolicitud=$consultandoSolicitudDocumentos->fetch_array(MYSQLI_ASSOC);
                        $id=$extraerTipoSolicitud['id'];
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            ?>
                            <input value="<?php echo $datosDoc['archivo_gestion'];?>" type="text" class="form-control" placeholder="Archivo en gestión" disabled>
                            <br>
                            <label>Archivo central: </label>
                            <input value="<?php echo $datosDoc['archivo_central'];?>" type="text" class="form-control"  placeholder="Archivo central" disabled>
                                <br>
                            <label>Archivo histórico: </label>
                            <input value="<?php echo $datosDoc['archivo_historico'];?>" type="text" class="form-control"  placeholder="Archivo histórico" disabled>
                            
                            <input value="<?php echo $datosDoc['archivo_gestion'];?>" type="hidden" required>
                            <input value="<?php echo $datosDoc['archivo_central'];?>" type="hidden"  required>
                            <input value="<?php echo $datosDoc['archivo_historico'];?>"type="hidden"  required>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            if($_POST['solitudElimin'] != NULL){
                            ?>
                            <textarea rows="3" class="form-control" placeholder="Disposición Documental" disabled><?php echo $datosDoc['disposicion_documental'];?></textarea>
                            <input name="diposicion_documental" type="hidden" value="<?php echo $datosDoc['disposicion_documental'];?>" required>
                            <?php
                            }else{
                            ...
                            if($_POST['solitudElimin'] != NULL){
                             ...
                             if($resposableDispoDoc != NULL){ 
                                ?>
                                    <input type="radio" id="rad_cargoD" name="radiobtnD" value="cargos" <?php echo $checkedDispoC;?> disabled>
                                    <label for="cargo">Cargo</label>
                                    <input type="radio" id="rad_usuarioD" name="radiobtnD" value="usuarios" <?php echo $checkedDispoU;?> disabled>
                                    <label for="usuarios">Usuarios</label>
        
                                    
                                    <div class="select2-blue">
                                        <select disabled class="select2" multiple="multiple" data-placeholder="Seleccionar encargado" style="width: 100%;" name="select_encargadoD[]" id="select_encargadoD" required></select>
                                    </div>
                                <?php
                                }else{ /// si viene por vigente un nombre se activa esta validación, caso contrario debe funcionar con normalidad el flujo
                                    $responsableDisposicion=json_decode($datosDoc['responsable_disposicion']);
                                    if($responsableDisposicion[0] == 'cargos' || $responsableDisposicion[0] == 'usuarios'){
                                        ...
                                        if($responsableDisposicion[0] == 'usuarios'){
                                         ...
                                         $enviarResponsableDisposicion=$datosDoc['responsable_disposicion'];
                                ...
                                ?>
                                    ...
                                    <div id="mostrarRetiradosR" style="display:<?php echo $ocultarVariableUsuariosRetiradoDisposicion; ?>;">
                                       <!-- <input type="hidden" name="radiobtnD" value="cargos">-->
                                        <div class="select2-blue" >
                                            <br>
                                            <input disabled type="text" class="form-control" id="retiradoTextoEncargado"  value="<?php echo $enviarResponsableDisposicion; ?>" >
                                        </div>
                                    </div>
                                        
                                    <div id="mostrarActivosR" style="display:<?php echo $ocultarVariableUsuariosActivoDisposicion; ?>;">
                                        <input type="radio" id="rad_cargoD" name="radiobtnD" value="cargos" <?php echo $responsableDisposicionCargo; ?>  disabled>
                                        <label for="cargo">Cargo</label>
                                        <input type="radio" id="rad_usuarioD" name="radiobtnD" value="usuarios" <?php echo $responsableDisposicionUsuario; ?> disabled>
                                        <label for="usuarios">Usuarios</label>
            
                                        <div class="select2-blue" >
                                            <select disabled class="select2" multiple="multiple" data-placeholder="Seleccionar" style="width: 100%;" name="select_encargadoD[]" id="select_encargadoD" ></select>
                                        </div>
                                ...
                                ?>
                                    ...
                                    <div id="mostrarRetiradosR" style="display:<?php echo $ocultarVariableUsuariosRetiradoDisposicion; ?>;">
                                       <!-- <input type="hidden" name="radiobtnD" value="cargos">-->
                                        <div class="select2-blue" >
                                            <br>
                                            <input type="text" class="form-control" id="retiradoTextoEncargado" name="select_encargadoDD" value="<?php echo $enviarResponsableDisposicion; ?>" >
                                        </div>
                                    </div>
    ...
    $(document).ready(function(){
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            $.post("selectDocumentosRechazados.php", { rad_post: rad_post, grupo: grupo, responsableDisposicion: responsableDisposicion}, function(data){
                $("#select_encargadoD").html(data);
            }); 
