          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" >
                 <form action="controlador/solicitudCompra/controllerOC" method="post">
                ...
                <div class="card-header">
                    ...
                    echo $proveedorCIudad=$extraerDatosProveedor['ciudad'];
                    // 
                    ...
                    $ciudad=$extraerDatosConsultaProveedor['ciudad'];
                    
                    
                    
                    $consultaCiudadesNombre = $mysqli->query("SELECT * FROM municipios WHERE id='$ciudad'");
                    $extraerDatosCiudadProveedor = $consultaCiudadesNombre->fetch_array(MYSQLI_ASSOC);
                    $ciudadProveedorDato=$extraerDatosCiudadProveedor['nombre'];
                    ...
                    echo '<br>';
                    echo '<b>CIUDAD</b> '.$ciudadProveedorDato;
                    echo '<br>';
                       ...
                       ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="float-right">
                                ...
                                ?>
                                <?php
                                $consultaExistenciaConsecutivo=$mysqli->query("SELECT * FROM consecutivoOC");
                                $datosConsecutivo=$consultaExistenciaConsecutivo->fetch_array(MYSQLI_ASSOC);
                                $consecutivo=$datosConsecutivo['id'];
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Contacte al administrador para configurar el consecutivo autoincrementable</p>
                                                    </div>
                                ...
                                ?>
                                <button type="submit" class="btn btn-primary " <?php echo $enviarNombreId;?> name="Actualizar">Calcular</button>
                                <?php
                ...
                <div class="card-body">
                    <form role="form" action="controlador/solicitudCompra/controllerAlistamiento" method="POST" enctype="multipart/form-data" onsubmit="return checkSubmit();" >
                        <input name="idOrdenCompra" value="<?php echo $_POST['idOrdenCompra']; ?>" type="hidden">
                        <input name="idUsuario" value="<?php echo $idparaChat; ?>" type="hidden">
                    <div class="chart">
                        <label>Comentarios:</label>
                        <br>
                        <textarea name="comentario" class="form-control" placeholder="Comentarios..." onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)"></textarea>  <br>
                        <button type="submit" class="btn btn-primary float-right" name="agregarComentarioB">Agregar</button>
                    </div>
                    </form>
                </div>
              </div>
