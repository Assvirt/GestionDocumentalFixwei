...
if(isset($_POST['AgregarProceso'])){
    ...
    $validacion1 = $mysqli->query("SELECT * FROM procesos WHERE nombre = '$nombre' AND estado IS NULL ");//consulta a base de datos si el nombre se repite
    ...
    $validacion2 = $mysqli->query("SELECT * FROM procesos WHERE prefijo = '$prefijo' AND estado IS NULL ");//consulta a base de datos si el nombre se repite
    $numPre = mysqli_num_rows($validacion2);
    if($numPre > 0){//si el nombre está repetido se pone falso
     //echo 'proceso prefijo';
        $insertarB = false;
    ...
    if($insertar != false && $insertarB != false){
...
if(isset($_POST['EditarProceso'])){
    ...
    $validacion1 = $mysqli->query("SELECT * FROM procesos WHERE nombre = '$nombre'  AND  estado IS NULL AND  id != '$id' ");//consulta a base de datos si el nombre se repite
    $numNom = mysqli_num_rows($validacion1);
    if($numNom > 0){//si el nombre está repetido se pone falso
    ...
    $validacion2 = $mysqli->query("SELECT * FROM procesos WHERE prefijo = '$prefijo' AND estado IS NULL AND id != '$id'");//consulta a base de datos si el nombre se repite
