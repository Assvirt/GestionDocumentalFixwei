...
if(isset($_POST['AgregarMacroproceso'])){
   ...
   $validacion = $mysqli->query("SELECT * FROM macroproceso WHERE nombre = '$nombre'  "); ///OR orden='$orden'
...
// funcion para quitar espacios
   ...
   $editar = true;
    ...
    $validacion1 = $mysqli->query("SELECT * FROM macroproceso WHERE nombre = '$nombre' AND id != '$id'");//consulta a base de datos si el nombre se repite
