        ...
        <?php
                ...
                if($anoSeleccionado > $anoActual){
                    ...
                    <?php
                        ...
                        $mysqli->query("INSERT INTO usuario (nombres,apellidos,cedula,clave,fechaNacimiento,cargo,lider,proceso,foto,telefono,correo,idCentroCostos,arl,eps,afp,estadoEliminado,estadoAnulado,sesionIP,estadoUsuario,contadorSesion) 
                            VALUES('$nombreUsuario','$apellido','$documento','$pass','$fechaNacimiento','$cargo','$lider','$proceso','$foto','$telefono','$correo','$idCentroCostos','$arl','$eps','$afp',FALSE,FALSE,'$direccionIPEmpresa','desconectado','0') ")or die(mysqli_error($mysqli));
                         ...
                         //   $mysqli->query("INSERT INTO ConectadoUsuario (idUsuario, estadoUsuario) VALUES ('$documento','Conectado')");
     ...
     ///////// consultamos la tabla y extraemos el nombre
      ...
      '<br>';
		...
		if($validandoUsuario['cedula'] == $documento || $repiteUser == 0){ //$repiteUser > 0 
		    ...
		    if($foto != NULL){
                $mysqli->query("UPDATE usuario SET  telefono='$telefono',foto ='$foto',clave='$pass',correo='$correo',nombres='$nombreUsuario', apellidos = '$apellido', fechaNacimiento='$fechaNacimiento', cargo='$cargo', lider='$lider', proceso='$proceso', cedula='$documento', idCentroCostos = '$idCentroCostos',arl='$arl',eps='$eps',afp='$afp' WHERE id = '$id'")or die(mysqli_error($mysqli));
                $mysqli->query("UPDATE chat_users SET username = '$nombreUsuario', password='$documento' WHERE password='".$_POST['cedulaAntigua']."' ")or die(mysqli_error($mysqli));
                ...
                $mysqli->query("UPDATE usuario SET  telefono='$telefono',clave='$pass',correo='$correo',nombres='$nombreUsuario', apellidos = '$apellido', fechaNacimiento='$fechaNacimiento', cargo='$cargo', lider='$lider', proceso='$proceso', cedula='$documento', idCentroCostos = '$idCentroCostos',arl='$arl',eps='$eps',afp='$afp' WHERE id = '$id'")or die(mysqli_error($mysqli));
                $mysqli->query("UPDATE chat_users SET username = '$nombreUsuario' WHERE password='$documento' ")or die(mysqli_error($mysqli));
...
if(isset($_POST['EliminarUsuario'])){
   ...
   $ingresaCC=$mysqli->query("INSERT INTO usuarioEliminado (quienelimina,idUsuario,nombres,apellidos,cedula,clave,fechaNacimiento,cargo,lider,proceso,telefono,correo,idCentroCostos,arl,eps,afp,idCentroTrabajo,grupo) 
        VALUES('$eliminador','$idUsuario','$nombreUsuario','$apellido','$documento','$pass','$fechaNacimiento','$cargo','$lider','$proceso','$telefono','$correo','$idCentroCostos','$arl','$eps','$afp','$idCentroTrabajo','$idGrupo') ")or die(mysqli_error($mysqli));
    ...
    if($ingresaCC != NULL){
        ...
        $mysqli->query("DELETE FROM chat_users WHERE password='$documento' ")or die(mysqli_error($mysqli));
        ////
    }
