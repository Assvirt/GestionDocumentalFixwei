...
if($numRows > 0){
  echo '<script language="javascript">alert("El tipo de solicitud ya existe.");
   ...
   $mysqli->query("INSERT INTO solicitudCompraTipo (tipo,tipoFrecuencia,frecuencia) 
...
if(isset($_POST['editar'])){
  ...
  if($tipoFrecuencia == 'ninguno'){
   ...
   $mysqli->query("UPDATE solicitudCompraTipo SET tipo='$tipo',tipoFrecuencia='$tipoFrecuencia',frecuencia='$almacenar' WHERE id = '$idTipoSolicitud'");
