...
if(isset($_POST['AgregarCargos'])){
    ...
    $nivelCargo = $_POST['nivelCargo'];
        ...
        $salida = Quitar_Espacios($nombreCargo);
        
        
    ///////// consultamos la tabla y extraemos el nombre
    $validacion = $mysqli->query("SELECT nombreCargos FROM cargos WHERE nombreCargos LIKE '%$salida%' ")or die (mysqli_error());
  ...
  /////////////// End validamos el nombre que entra al nombre de la consulta
    ...
    $validacion1 = $mysqli->query("SELECT * FROM cargos WHERE nombreCargos = '$salida' AND id_cargos != '$id'");//consulta a base de datos si el nombre se repite
