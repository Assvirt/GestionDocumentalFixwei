...
if($hasta < $desdeMostrar){  /// la validacion de las fechas si la fecha final es menor a la fecha dfinal nos arroja un error
    ...
    responsableCalculo='$responsableCalculo',radioVisualizar='$radiobtnAut',autorizadoVisualizar='$autorizadosVisualizar',restrincion='$restrincion',formula='$formula',terminar2='$terminar' WHERE id='$idIndicador' ")or die(mysqli_error($mysqli));
    ...
    $mysqli->query("UPDATE indicadoresMetas SET unidad='$unidad',metaActual='$metaActual',desde='$desde',hasta='$hasta', zp='$zp', za='$za', zc='$zc', ze='$ze' WHERE idIndicador='$idIndicador' ")or die(mysqli_error($mysqli));
