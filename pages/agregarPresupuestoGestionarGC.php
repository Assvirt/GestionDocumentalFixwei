...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          ?>
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar Grupo de Costo</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php 
                    ...
                    $queryGrupo = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE id = '$idGrupo'");
                    $datosGrupo = $queryGrupo->fetch_array(MYSQLI_ASSOC);
                    $nombreGrupo = $datosGrupo['nombreGC'];
              ?>
              <form role="form" action="controlador/presupuesto/controllerPrespuestoGestionGC" method="POST">
                <div class="card-body">
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE idPresupesto='$idPresupuesto' AND modulo='grupo'  ORDER BY nombreGC ASC")or die(mysqli_error());
                     while($row = $data->fetch_assoc()){
                    echo"<tr>";
                    $id=$row['id'];
                    
                            $acentos2 = $mysqli->query("SET NAMES 'utf8'");
                            $queryGrupoValidacion = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE grupo = '$id'");
                    ...
                    echo "<td>";
                            /////////// se valida si el grupo est�� atado a un sub-grupo y puedas eliminarlos o editarlos
                            $queryGrupoValidacion = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE grupo = '$id'");
                    ...
                    echo"</form>";
                    /////////// se valida si el grupo est�� atado a un sub-grupo
                    $queryGrupoValidacion = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE grupo = '$id'");
                    ...
                    echo"<form action='agregarPresupuestoGestionarGCValidarEliminar' method='POST'>";
                    echo"<input type='hidden' name='idGrupos' value= '$id' >";
                    echo"<input type='hidden' name='idPresupuesto' value= '$idPresupuesto' >";
                    echo"<input type='hidden' name='subgrupo' value= 'grupo' >";
                    ...
                    echo"<form action='controlador/presupuesto/controllerPrespuestoGestionGC' method='POST'>";
                    echo"<input type='hidden' name='idGrupos' value= '$id' >";
                    echo"<input type='hidden' name='idPresupuesto' value= '$idPresupuesto' >";
                    echo" <td><button onclick='return ConfirmDelete()' type='submit' name='EliminarGC' class='btn btn-block btn-danger btn-sm'><i class='fas fa-trash-alt'></i> Eliminar</button></td>";
                    echo"</form>";    
    ...
    </div> <!-- ac�� finaliza la vista de grupos -->
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <?php 
                    ...
                    $acentos2 = $mysqli->query("SET NAMES 'utf8'");
                    $queryGrupo = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE id = '$idSGrupo'");
                    $datosGrupo = $queryGrupo->fetch_array(MYSQLI_ASSOC);
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select type="text" class="form-control"  name="grupo" placeholder="Grupo" required>
                        <?php
                        $acentos2 = $mysqli->query("SET NAMES 'utf8'");
                        $queryGrupoS = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE id='$Grupo'  ORDER BY nombreGC ASC ");
                        ...
                        <?php 
                        $acentos2 = $mysqli->query("SET NAMES 'utf8'");
                        $queryGrupoS = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE idPresupesto='$idPresupuesto' AND modulo='grupo'  ORDER BY nombreGC ASC ");
                         while($datosGrupoS = $queryGrupoS->fetch_assoc()){
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     require 'conexion/bd.php';
                     $acentos = $mysqli->query("SET NAMES 'utf8'");
                     $data = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE idPresupesto='$idPresupuesto' AND modulo='subgrupo' AND grupo='$idSGrupo' ORDER BY nombreSGC ASC")or die(mysqli_error());
                     while($row = $data->fetch_assoc()){
                 
                 
                    echo"<tr>";
                    $idGrupoS=$row['grupo'];
                    $queryGrupoC = $mysqli->query("SELECT * FROM presupuestoGrupos WHERE id = '$idGrupoS'");
  ...
  ?>
   <section class="content">
    ...
    </div>  <!-- ac�� finaliza la vista de Sub-grupos -->
  <?php
  }
  ?>
