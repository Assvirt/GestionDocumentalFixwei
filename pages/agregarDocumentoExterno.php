                  ...
                  <?php
                    ...
                    <div  class="form-group">
                        ...
                        <select type="text" class="form-control" id="tipo" name="tipo" placeholder="" required>
                            ...
                            if($_POST['tipo'] != NULL){
                            $resultadosubconsulta=$mysqli->query("SELECT * FROM documentoExternoTipo WHERE id='".$_POST['tipo']."' ORDER BY nombre");
                            $extraerResultadocpnsulta=$resultadosubconsulta->fetch_array(MYSQLI_ASSOC);
                            ?>
                            <option value='<?php echo $extraerResultadocpnsulta['id'];?>'><?php echo $extraerResultadocpnsulta['nombre'];?></option>
                            <?php
                            }else{
                            ?>
                            ...
                            $acentos = $mysqli->query("SET NAMES 'utf8'");
                            if($_POST['tipo'] != NULL){
                            $resultado=$mysqli->query("SELECT * FROM documentoExternoTipo WHERE not id='".$_POST['tipo']."' ORDER BY nombre");    
                            }else{
