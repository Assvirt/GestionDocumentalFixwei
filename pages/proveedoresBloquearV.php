  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Proveedores bloqueados</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Proveedores bloqueados</li>
            </ol>
          </div>
        </div>
        <div>
                ...
                <table class="table table-head-fixed text-center" id="example">
                  <thead>
                    <tr>
                      ...
                      <!--<th>Meses para actualizaci&oacute;n</th>
                  ...
                  <tbody>
                    ...
                    $data = $mysqli->query("SELECT * FROM proveedores WHERE estado='bloqueo' ORDER BY razonSocial ASC")or die(mysqli_error());
                    ...
                    */
                    ...
                    echo"<input type='hidden' name='idProveedor' value= '$id' >";
                    echo" <td style='display:$visibleD;'><button type='submit' class='btn btn-block btn-warning btn-sm'><i class='fas fa-lock-open'></i> Desbloquear</button></td>";
                    echo"</form>";
