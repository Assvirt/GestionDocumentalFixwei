...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Editar Documentos del Proveedor</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Editar Documentos del Proveedor</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Editar documentos del proveedor</li>
            </ol>
          </div>
        </div>
        <div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              $consulta=$mysqli->query("SELECT * FROM proveedordocumentos WHERE id='".$_POST['idA']."' ");
              $extraer=$consulta->fetch_array(MYSQLI_ASSOC);
              
              ?>
              <form role="form" action="controlador/proveedor/controllerDocumento" method="POST" enctype="multipart/form-data">
                  
                  
                   <input name="nombreCarpeta" value="<?php echo $_POST['nombreCarpeta']; ?>" type="hidden" placeholder="nombre carpeta">    
                              <input name="id" value="<?php echo $_POST['id']; ?>" type="hidden" placeholder="id">
                              <input name="filas" value="<?php echo $_POST['filas']; ?>" type="hidden" placeholder="filas">
                              <?php
                              // mantenemos la carpeta abierta
                              if($_POST['mantenerAbierto'] != NULL){
                              ?>
                                <input name="agregarArchivosDocumentos" value="1" type="hidden" placeholder="arhivo abierto">
                              <?php
                              }
                  ...
                  <input name="idA" value="<?php echo $extraer['id']; ?>" type="hidden">
                <div class="card-body">
                             ...
                             <label for="upload-photo">Archivo (Máx 10MB):</label>
                              <div class="input-group">
                                <div class="custom-file">
                                  <input type="file" class="custom-file-input" id="miInput" name="soporte"  >
