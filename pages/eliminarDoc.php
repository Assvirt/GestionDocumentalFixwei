...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Eliminar documento</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            ?>
            <h1><?php echo $títulRol; //echo ' - '.$variableValidadoB.' - '.$datosDoc['asumeFlujo'].' - '.$datosDoc['estadoActualiza'];?></h1>
          </div>
    ...
    <?php 
        $acentos = $mysqli->query("SET NAMES 'utf8'");
        $control = $mysqli->query("SELECT * FROM controlCambios WHERE idDocumento = '$idSolicitudEliminar'")or die(mysqli_error($mysqli));
                                    ...
                                    <div style="padding: 20px;" class="tab-pane" id="timeline">
                                        ...
                                        <div class="timeline timeline-inverse">
                                          ...
                                          <?php 
                                            ...
                                            $queryControl = $mysqli->query("SELECT * FROM controlCambios WHERE idDocumento = '$idSolicitudEliminar' ORDER BY fecha DESC")or die(mysqli_error($mysqli));
                                            $i=0;
                                            while($i < 1){
                                          ...
                                          <div>
                                            ...
                                            <div class="timeline-item">
                                              ...
                                              <h3 class="timeline-header border-0"><b><?php echo $rol?></b> - <a href="#"><?php echo $nombreUsuario?></a> <?php  if($row['comentario'] != NULL){ echo $row['comentario']; }else{ echo 'N/A';} ?>
                                              </h3>
                                            </div>
                                          </div>
                                        <?php }?>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <form role="form" action="eliminarDoc2" method="POST">
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Nombre del documento: </label>
                            <input value="<?php echo $datosDoc['nombres']?>" type="text" class="form-control" disabled placeholder="Nombre del documento">
                             <input value="<?php echo $datosDoc['nombres']?>" type="hidden" class="form-control" name="nombreDocumento" placeholder="Nombre del documento">
                        </div>
                        <script type="text/javascript">
                               $(document).ready(function() {
                                $('.readonly').find('input, duallist, select').attr('readonly', 'readonly');
                            });
                        </script>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            ?>
                            <input  name="proceso" value="<?php echo $datosDoc['proceso']; ?>" type="hidden">
                            <select type="text" class="form-control" id="descripcion"  placeholder="Proceso" disabled>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            ?>
                            <label>Norma: </label>
                              <select class="duallistbox" name="norma[]" multiple style="display: none; readonly">
                                <?php
                                    while ($columna = mysqli_fetch_array( $resultado )) {
                                      if($arrayNormas != NULL){ 
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div><br>
                                ...
                                ?>
                                <input  name="tipoDoc" value="<?php echo $datosDoc['tipo_documento']; ?>" type="hidden">
                                <select type="" class="form-control" id="descripcion" disabled placeholder="">
                                    ...
                                    ?>
                                    <option value="<?php echo $columna['id']; ?>"  <?php echo $selectTipoDoc; ?> disabled><?php echo $columna['nombre']; ?> </option>
                                    <?php }  ?>
                                </select>
                            </div>
                            ...
                            <div><br>
                                ...
                                <input value="<?php echo $datosDoc['ubicacion']; ?>" type="hidden" class="form-control" name="ubicacion" placeholder="Ubicación">
                                <input value="<?php echo $datosDoc['ubicacion']; ?>" type="text" class="form-control" name="" placeholder="Ubicación" disabled>
                            </div>
                        </div>
                    ...
                    //aca voy a validar si son usuarios o cargos los que se encargan de elaborar, revisar, aprobar            
                        ...
                        if($datosDoc['estadoElimina'] == NULL){// elaboraElimanar si el estado es null quiere decir que no se ah asigando quien elabora, revisa, aprueba entonces puede asigar quien lo hace
                            $display = "";
                        }else{
                            $display = "none";
                        }
...
<script>
    $(document).ready(function(){
        $('#rad_cargoE').click(function(){
            rad_cargo = "cargo";
            $.post("selectDocumentosEliminar.php", { rad_cargo: rad_cargo }, function(data){
                $("#select_encargadoE").html(data);
            }); 
        });
        $('#rad_usuarioE').click(function(){
            rad_usuario = "usuario";
            $.post("selectDocumentosEliminar.php", { rad_usuario: rad_usuario }, function(data){
                $("#select_encargadoE").html(data);
            }); 
        });
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            $.post("selectDocumentosEliminar.php", { rad_post: rad_post, grupo: grupo, radEncargado: radEncargado}, function(data){
                $("#select_encargadoE").html(data);
            }); 
    ...
    $(document).ready(function(){
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            $.post("selectDocumentosEliminar.php", { rad_post: rad_post, grupo: grupo, radRevisar: radRevisar}, function(data){
                $("#select_encargadoR").html(data);
            }); 
            // only one radio can be logically checked, don't check the rest
            break;
    ...
    $(document).ready(function(){
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            $.post("selectDocumentosEliminar.php", { rad_post: rad_post, grupo: grupo, radAprobar: radAprobar}, function(data){
                $("#select_encargadoA").html(data);
            }); 
            // only one radio can be logically checked, don't check the rest
            break;
