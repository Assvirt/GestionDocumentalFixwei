        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Editar Tipo Documento</li>
            </ol>
          </div>
        </div>
        <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm">
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="tipoDocumentoExterno"><font color="white"><i class="fa fa-list"></i> Listar</font></a></button>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-9">
                <?php
                    ...
                    $data = $mysqli->query("SELECT * FROM documentoExternoTipo WHERE id = '$id'");
                    $col = $data->fetch_array(MYSQLI_ASSOC);
                    $nombre = $col['nombre'];
                    $tipo = $col['tipoDocumento'];
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="controlador/documentoExterno/controllerTipoExterno" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer" >
                   ...
                   <button type="submit" name="editar" class="btn btn-primary float-right">Editar</button>
                </div>
              </form>
            </div>
            </div>    
