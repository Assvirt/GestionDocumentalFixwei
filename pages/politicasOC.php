...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Agregar politica Orden de Compra</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar Politicas Orden de Compra</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar política</li>
            </ol>
          </div>
        </div>
        <div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="controlador/politicas/politicasController" method="POST">
                ...
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <?php
                     ...
                     echo" <td style='text-align: justify;'><textarea onkeypress='return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218 || event.charCode == 13 || event.charCode == 45 || event.charCode == 42 || event.charCode == 36)' class='form-control' name='politica' cols='$ancho' rows='$lineas' style='border-color:;width:;Height:;' >".$nombrePolitica."</textarea></td>";
                    ?>
                ...
                <div class="card-footer" >
                  ...
                  <button type="submit" class="btn btn-primary float-right" name="AgregarPolitica">Agregar</button>
                </div>
              </form>
            </div>
            </div>    
