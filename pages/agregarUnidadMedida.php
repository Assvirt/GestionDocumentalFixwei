...
<!DOCTYPE html>
<html>
    <title>Agregar Unidad Medida</title>
        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php 
                    $query = $mysqli->query("SELECT * FROM proveedoresProductoMedida WHERE id = '$idProveedorGrupo'");
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='agregarUnidadEmpaque'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM proveedoresProductoMedida order by grupo")or die(mysqli_error());
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/proveedor/controllerProductoMedida' method='POST'>
