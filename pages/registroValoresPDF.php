                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            -->
                         <div class="col-sm">
                            <form action="registroValores" method="post">
        ...
        <div class="row">
                    ...
                    <div class="col-sm-4 invoice-col">
                      ...
                      <address>
                        <strong>Orden de Compra # &nbsp;
                                <?php  echo $idSolicituCOmprador; /// se coloca esta variable en reemplazo de la impresión de consecutivo
               ...
               <div class="form-group" >
                  ...
                  <br>     
                   ...
                   echo '<b>Método de pago ';
                   echo '<br>';
                   echo ''.ucwords($titulo);
                   echo '<br>';
                   echo 'Descripción: '.$descrpcion;
                   echo '</b><br><br>';
                   ?>
                   <br>
                  <div  class="form-group no-print">
                   ...
                   <?php
                /// validamos si el usuario tiene el permiso del grupo de distribución, hacemos el recorrido para buscar el que está activo de diferentes grupos
                $permisoHabilitado=$mysqli->query("SELECT * FROM `permisos` WHERE formulario='aprobacionOC' AND listar='1'");
                while($extrerPermisoHabilitado=$permisoHabilitado->fetch_array()){
                     'id permido: '.$idPermisosGrupo=$extrerPermisoHabilitado['idGrupo'];
                }
                     ' - cc'.$cc;
                ...
                'grupo activo: '.$habilitarPermisoBotonGrupo=$extraerValidacionGrupo['id'];
