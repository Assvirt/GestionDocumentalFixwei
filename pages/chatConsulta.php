...
function redireccion() {
   window.location = "chatConsulta.php";
}
...
<div class="col-6">
                        ...
                        <!--/.direct-chat -->
                            ...
                            <?php
                                 ...
                                 $sesionU=$_SESSION["session_username"];
                                 $queryJefeInmediato=$mysqli->query("SELECT * FROM usuario WHERE cedula='$sesionU' ");
            	                 $rowDatos=$queryJefeInmediato->fetch_array(MYSQLI_ASSOC);
            	                 $idparaChat=$rowDatos['id'];
                            ...
                            ////////// datos del receptor
                                ...
                                $queryJefeInmediato=$mysqli->query("SELECT * FROM usuario WHERE id='$idIniciarChat' ");
            	                 $rowDatos=$queryJefeInmediato->fetch_array(MYSQLI_ASSOC);
            	                 echo $nombreReceptor=$rowDatos['nombres'];
                      ...
                      <!-- /.card-header -->
                              <div class="card-body">
                                ...
                                <script>
                                    ...
                                    //document.getElementById('vercont').scrollTop=5000;});
                                </script>
                                <div class="direct-chat-messages" id="vercont">
                              ...
                              <div class="card-footer">
                                    <form action="" method="post"><!-- controlador/comunicacionInterna/controllerComunicacionInterna -->
                                      ...
                                      <input type="" name="de" value="<?php echo $idparaChat; ?>">
                                      <input type="" name="para" value="<?php echo $idIniciarChat; ?>">
