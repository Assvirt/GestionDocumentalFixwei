...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Agregar Criticidad</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar Tipo de Criticidad</h1> 
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar Tipo de Criticidad</li>
            </ol>
          </div>
        </div>
        <div>
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-block btn-success btn-sm"><a href="proveedoresInscripcion"><font color="white"><i class="fas fa-list"></i> Regresar a Proveedores</font></a></button>
                        </div>
                    </div>
                </div>
                <div class="col">
        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php 
                    $query = $mysqli->query("SELECT * FROM proveedoresCriticidad WHERE id = '$idProveedorGrupo'");
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='agregarProveedoresCriticidad'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM proveedoresCriticidad order by tipo")or die(mysqli_error());
                    ...
                    $id=$row['id'];
                    echo"<form action='agregarProveedoresCriticidad' method='POST'>";
                    ...
                    echo"</form>";
                    /*
                    echo"<form action='controlador/proveedor/controllerTipo' method='POST'>";
                    echo"<input type='hidden' name='idProveedorGrupo' value= '$id' >";
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/proveedor/controllerCriticidad' method='POST'>
...
<script type="text/javascript">
	function ConfirmDelete(){
		var answer = confirm("驴Esta seguro de eliminar?");
