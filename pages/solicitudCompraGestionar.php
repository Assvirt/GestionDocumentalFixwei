              ...
              <div class="card-body">
                <div class="chart">
                      ...
                      <form role="form" action="controlador/solicitudCompra/controllerAlistamiento" method="POST" enctype="multipart/form-data" onsubmit="return checkSubmit();" >
                            &nbsp Aprobado <input name="opcion" value="aprobado" id="aprobar" type="radio" id="aprobado" required>&nbsp;
                            ...
                            <?php
                            $validacionUltimapAorbacion=$mysqli->query("SELECT * FROM `solicitudCompraFlujo` WHERE idSolicitud='".$_POST['idOrdenCompra']."' AND idUsuario='$idparaChat' AND estado='pendiente' AND rol='2' ");
                            ...
                            ?>
                            <div id="comprador" style="display:none;">
                                <br>
                             ...
                             <input type="hidden" value="Aprobador" name="rol">
                            <?php
                                //}
                            }else{
                                //echo 'Primer Rol';
                                ?>
                                <input type="hidden" value="Revisor" name="rol">
                                <?php
                            ...
                            if($extraerDatpsValidacion != NULL){
                                ...
                                <div id="notificacion" style="display:none;">
                                 ...
                                 <div id="notificacionComprador" style="display:none;">
