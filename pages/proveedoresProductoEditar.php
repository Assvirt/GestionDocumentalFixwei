...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Editar Productos del Proveedor</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Editar productos del proveedor</li>
            </ol>
          </div>
        </div>
        <div>
            <div class="row">
                <div class="col">
                <?php
                'ProveedorA:'.$idProveedor=$_POST['idProveedor'];
                ?>    
                </div>
                 <div class="col-9">
                    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <form role="form" action="controlador/proveedor/controllerProducto" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                <?php
                    //echo 'Id proveedor:'.$idProveedor=$_POST['idProveedor'];
                    ...
                    $codigo= $row['codigo'];
                    'Tipo --'. $tipoPorducto=$row['tipoProducto'];
                    $costo = $row['costo'];
                ...
                <!-- Fin parametros para la activacion de correo y plataforma -->
                   <?php 
                    ...
                    <div class="row">
                        <div class="container">
                              Bienes <input name="opcion" value="1" type="radio" id="bienes"  <?php echo $checkedPro; ?> required>&nbsp; 
                              Servicios <input name="opcion" value="2" type="radio" id="servicios" <?php echo $checkedSer; ?> required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                                ...
                                <select type="text" class="form-control"  name="grupo" >
                                   ...
                                   <?php
                                    ...
                                    $length = 2;
                                    $string = substr(str_repeat(0, $length).$number, - $length);
                                    $unidadMedida=$mysqli->query("SELECT * FROM proveedoresProductoGrupo WHERE not id='$grupo' ORDER BY grupo ");
                                    while($extraerMedida=$unidadMedida->fetch_array()){
                                        /// consultamos los datos del subGrupo
                                        $consultaSubGrupo=$mysqli->query("SELECT * FROM proveedoresProductoSubGrupo WHERE id='".$extraerMedida['sub']."' ");
                                        $extraerSubGrupo=$consultaSubGrupo->fetch_array(MYSQLI_ASSOC);
                        ...
                        <div class="form-group col-sm-6">
                            <label>Código:</label>
                           <input type="text" class="form-control"  name="codigo" value="<?php echo $codigo; ?>" placeholder="Código" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <!--<input type="text" class="form-control"  name="identificador" value="<?php //echo $identificador; ?>" placeholder="Identificador" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                            -->
                             <select type="text" class="form-control"  name="identificador" required>
                                    ...
                                    ?>
                                    <?php
                                    $unidadIdentificador=$mysqli->query("SELECT * FROM proveedoresProductoIdentificador WHERE not id='$identificador' ORDER BY grupo ");
                                    while($extraerIdentificador=$unidadIdentificador->fetch_array()){
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <select type="number" min="0" class="form-control"  name="impuesto" >
                                ...
                                ?>
                                <option value="<?php echo $extraerConsultaImpuestos['id']; ?>"><?php echo $extraerConsultaImpuestos['grupo'].' '.$extraerConsultaImpuestos['descripcion'].' %'; ?></option>
                                <?php
                                }
                                ?>
                                 <option value="N/A">N/A</option>
                                <?php
                                $consultaImpuestos=$mysqli->query("SELECT * FROM proveedoresTipoImpuesto WHERE not id='$impuesto' ORDER BY id");
                                while($extraerConsultaImpuestos=$consultaImpuestos->fetch_array()){
                                ?>
                                <option value="<?php echo $extraerConsultaImpuestos['id']; ?>"><?php echo  $extraerConsultaImpuestos['grupo'].' '.$extraerConsultaImpuestos['descripcion'].' %'; ?></option>
                                <?php
                    ...
                    ?>
                    <div id="bienesF" style = "display:<?php echo $form1; ?>;" >
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <select type="text" class="form-control"  name="presentaciona" >
                                    ...
                                    if($tipoPorducto == '1'){
                                        ...
                                        <?php
                                        $unidadMedida=$mysqli->query("SELECT * FROM proveedoresProductoEmpaque WHERE id ='$presentacion' ORDER BY grupo  ");
                                        while($extraerMedida=$unidadMedida->fetch_array()){
                                        ?>
                                        ...
                                        ?>
                                        <?php
                                        $unidadMedida=$mysqli->query("SELECT * FROM proveedoresProductoEmpaque WHERE NOT id='$presentacion' ORDER BY grupo  ");
                                        while($extraerMedida=$unidadMedida->fetch_array()){
                                        ?>
                                        <option value="<?php echo $extraerMedida['id'];?>"><?php echo $extraerMedida['grupo'].' - '.$extraerMedida['descripcion'];?></option>
                                        <?php
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select type="text" class="form-control"  name="presentacionb" >
                                     <?php
                                      if($tipoPorducto == '1'){
                                            $consultaUnidad=$mysqli->query("SELECT * FROM proveedoresProductoMedida WHERE id='$presentacionb' ORDER BY grupo");
                                            while($extraerConsultaUnidad=$consultaUnidad->fetch_array()){
                                            ?>
                                            <option value="<?php echo $extraerConsultaUnidad['id']; ?>"><?php echo $extraerConsultaUnidad['grupo'].' '.$extraerConsultaUnidad['descripcion'].''; ?></option>
                                            <?php
                                            }
                                            
                                            $consultaUnidad=$mysqli->query("SELECT * FROM proveedoresProductoMedida WHERE NOT id='$presentacionb' ORDER BY grupo");
                                            while($extraerConsultaUnidad=$consultaUnidad->fetch_array()){
                                            ?>
                                            <option value="<?php echo $extraerConsultaUnidad['id']; ?>"><?php echo $extraerConsultaUnidad['grupo'].' '.$extraerConsultaUnidad['descripcion'].''; ?></option>
                                            <?php
                                      ...
                                      /*}else{
                                          ...
                                          <option value=""></option>
                                          <?php
                                             $consultaUnidad=$mysqli->query("SELECT * FROM proveedoresProductoMedida  ORDER BY grupo");
                                            while($extraerConsultaUnidad=$consultaUnidad->fetch_array()){
                                            ?>
                                            <option value="<?php echo $extraerConsultaUnidad['id']; ?>"><?php echo $extraerConsultaUnidad['grupo'].' '.$extraerConsultaUnidad['descripcion'].''; ?></option>
                                            <?php
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select type="text" class="form-control"  name="inventario">
                                    <?php
                                      if($inventario != NULL){
                                    ?>
                                     <option value="<?php echo $inventario;?>"><?php echo $inventario;?></option> 
                                    <?php
                                    if($inventario == 'Si'){
                                    ?>
                    ...
                    <div id="serviciosF" style = "display:<?php echo $form2; ?>;">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <select type="text" class="form-control"  name="proveedor" >
                                    ...
                                    ?>
                                     <option value=""></option> 
                                        <?php
                                        $consultandoProeedores=$mysqli->query("SELECT * FROM proveedores ORDER BY razonSocial");
                                        ...
                                        $consultandoProeedores=$mysqli->query("SELECT * FROM proveedores WHERE id ='$idProveedor'");
                                        while($extraerconsultaProve=$consultandoProeedores->fetch_array()){
                                        ?>
                                        <option value="<?php echo $extraerconsultaProve['id']; ?>"><?php echo $extraerconsultaProve['razonSocial']; ?></option>
                                        <?php
                                        ...
                                        ?>
                                        <?php
                                        $consultandoProeedores=$mysqli->query("SELECT * FROM proveedores WHERE NOT id ='$idProveedor'");
                                        while($extraerconsultaProve=$consultandoProeedores->fetch_array()){
                                        ?>
                                        <option value="<?php echo $extraerconsultaProve['id']; ?>"><?php echo $extraerconsultaProve['razonSocial']; ?></option>
                                        <?php
                             ...
                             <div class="form-group col-sm-6">
                                <label>Tiempo de servicio:</label><br>
                                
                                <?php
                                $tiempoServicio; 
                                $cantidadTiempoServicio;
                                ...
                                echo $extraerDatos['grupo'];    
                                    if($tiempoServicio == $extraerDatos['id']){
                                        $activandoChecked='checked';
                                ?>
                                    <input type="radio" name="tiempoServicio" value="<?php echo $extraerDatos['id']; ?>" <?php echo $activandoChecked; ?> >
                                &nbsp;
                                <?php
                                ...
                                <br><br>
                                <input type="number" min="0" class="form-control"  name="cantidadTiempoServicio" value="<?php echo $cantidadTiempoServicio;?>">
