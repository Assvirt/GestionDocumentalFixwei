        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php 
                    $query = $mysqli->query("SELECT * FROM proveedoresGrupo WHERE id = '$idProveedorGrupo'");
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM proveedoresGrupo order by grupo")or die(mysqli_error());
                    ...
                    $id=$row['id'];
                    echo"<form action='agregarProveedoresGrupos' method='POST'>";
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/proveedor/controllerGrupo' method='POST'>
