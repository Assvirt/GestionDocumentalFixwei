...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>FIXWEI - Agregar impuesto</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="home">Inicio</a></li>
              <li class="breadcrumb-item active">Agregar Impuesto</li>
            </ol>
          </div>
        </div>
        <div>
        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php 
                    $query = $mysqli->query("SELECT * FROM proveedoresTipoImpuesto WHERE id = '$idProveedorGrupo'");
                ...
                ?>
              <form role="form" action="controlador/proveedor/controllerTipoImpuesto" method="POST">
                  <input name="idProveedorGrupo" value="<?php echo $idDatos; ?>" type="hidden">
                <div class="card-body">
                  <div class="form-group">
                    <label>Nombre del impuesto:</label>
                    <input type="text" class="form-control" name="grupo" value="<?php echo $grupo; ?>" placeholder="Tipo" required onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)">
                    <br>
                    <label>Impuesto (%):</label>
                    <br>
                    <input type="number" min="0" class="form-control"  name="descripcion" placeholder="Impuesto"  value="<?php echo $descripcion; ?>" required>
                    <br>
                    <label>Descripción</label>
                    <textarea class="form-control" name="des" required onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 209 || event.charCode == 241 || event.charCode == 32  || event.charCode == 225 || event.charCode == 233 || event.charCode == 237 || event.charCode == 243 || event.charCode == 250 || event.charCode == 44 || event.charCode == 46 || event.charCode == 193 || event.charCode == 201 || event.charCode == 205 || event.charCode == 211 || event.charCode == 218)"><?php echo $des;?></textarea>
                  </div>
              ...
              <div class="card-footer">
                  <button type="button" onclick="window.location='agregarProveedoresProductosImpuesto'" class="btn btn-success float-right">Cerrar</button>
              </div>
            </div>
            <?php
                }else{
              ...
              <form role="form" action="controlador/proveedor/controllerTipoImpuesto" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <label>Impuesto (%):</label>
                    <br>
                    <input type="number" min="0" class="form-control"  name="descripcion" placeholder="Impuesto" required>
                    <br>
                    <label>Descripción</label>
        ...
        <div class="card-body table-responsive p-0" style="height: 800px;">
                <table class="table table-head-fixed text-center">
                  ...
                  <tbody>
                     ...
                     $data = $mysqli->query("SELECT * FROM proveedoresTipoImpuesto order by grupo")or die(mysqli_error());
                    ...
                    echo" <td>".$row['des']."</td>";
                    $id=$row['id'];
                    echo"<form action='agregarProveedoresProductosImpuesto' method='POST'>";
                   ...
                   <div class="modal fade" id="modal-danger">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <form action='controlador/proveedor/controllerTipoImpuesto' method='POST'>
