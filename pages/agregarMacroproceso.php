...
$formulario = 'macroprocesos'; //Se cambia el nombre del formulario
...
<head><meta charset="gb18030">
  ...
  <title>FIXWEI - Agregar macroproceso</title>
            ...
            <div class="col-9">
              ...
              <form role="form" action="controlador/macroproceso/controladormacroproceso" method="POST">
                ...
                <!-- Fin parametros para la activacion de correo y plataforma -->
                  ...
                  <div class="form-group">
                    <label>Orden:</label>
                    <input type="number" class="form-control" min="1" name="orden" placeholder="Orden" required>
                  </div>
                    -->
                  <div class="form-group">
