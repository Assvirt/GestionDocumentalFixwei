...
$rolFlujo = $_POST['rol'];
echo '<font color="white">'.$idDoc = $_POST['idDoc']; echo '</font>';
...
$consultamosComentario=$mysqli->query("SELECT * FROM comentarioSolicitud WHERE idSolicitud='".$datosDoc['id_solicitud']."' AND comentario='$comentarios' ");
$extraerConsultamosComentario=$consultamosComentario->fetch_array(MYSQLI_ASSOC);
if($extraerConsultamosComentario['id'] != NULL){
    
}else{
    $mysqli->query("INSERT INTO comentarioSolicitud (idSolicitud,comentario) VALUES ('".$datosDoc['id_solicitud']."','$comentarios')");    
}
    ...
    $update = $mysqli->query("UPDATE documento SET asumeFlujo = '$idUsuario' WHERE id = '$idDoc' ");
        ?>    
            <script> 
                 ...
                 setTimeout(clickbuttonArchivoEditable, 0000);
                 function clickbuttonArchivoEditable() { 
                    document.forms["miformularioA"].submit();
                 }
            </script>
             
            <form name="miformularioA" action="solicitudRechazada" method="POST" onsubmit="procesar(this.action);" >
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            if($tipoSolicitudAndante == '1'){
                if($variableValidado == $datosDoc['asumeFlujo'] && $datosDoc['estado'] == null || $datosDoc['estado'] == 'Pendiente'){
            ...
            ?>
            <h1><?php echo $títulRol; //echo ' - '.$variableValidadoB.' - '.$datosDoc['asumeFlujo'].' - '.$estadoActual;?></h1>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-9">
              ...
              <form role="form" action="solicitudRechazada2" method="POST">
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Nombre del documento: </label>
                            <?php  $tipoSolicitudAndante;
                            if($tipoSolicitudAndante == '3'){
                            ?>
                            <input value="<?php echo $datosDoc['nombres']?>" type="text" class="form-control" disabled>
                            <input value="<?php echo $datosDoc['nombres']?>" type="hidden" >
                            <?php
                            }else{
                            ?>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            if($tipoSolicitudAndante == '3' || $tipoSolicitudAndante == '2'){
                            ?>
                            ...
                            <input value="<?php echo $datosDoc['proceso'];?>" type="hidden" name="proceso">
                            
                            <?php  
                            }else{
                            ?>
                            <select class="form-control" id="descripcion" name="proceso" >
                                <option value=''>Seleccionar proceso</option>
                                <?php
                                while ($columna = mysqli_fetch_array( $resultado )) { 
                                    if($datosDoc['proceso'] == $columna['id']){
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            if($tipoSolicitudAndante == '3'){
                            ?>
                              <select class="duallistbox" disabled multiple>
                                <?php
                                    while ($columna = mysqli_fetch_array( $resultado )) { 
                                      if($arrayNormas != NULL){
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div><br>
                                ...
                                ?>
                                <select type="text" class="form-control" id="descripcion" name="tipoDoc" >
                                    <option value=''>Seleccionar tipo documento</option>
                                    <?php
                                    while ($columna = mysqli_fetch_array( $resultado )) {
                                        if($datosDoc['tipo_documento'] == $columna['id']){
                    ...
                    //aca voy a validar si son usuarios o cargos los que se encargan de elaborar, revisar, aprobar            
                        ...
                        if($tipoSolicitudAndante == '1'){
                            ...
                            $revisa = json_decode($datosDoc['revisaElimanar']);
                            $aprueba = json_decode($datosDoc['apruebaElimanar']);
                        }
                    ...
                    <div class="row" style="display:<?php //echo $display;?>;">
                        <div class="form-group col-sm-6">
                            ...
                            if($tipoSolicitudAndante == '3'){
                            ?>
                                <input name="solitudElimin" value="3" type="hidden" >
                            <?php
                                $validacion='disabled';
                            }else{
                                $validacion='';
                            ...
                            <input type="radio" id="rad_cargoE" name="radiobtnE" value="cargos" <?php echo $checkedCElabora;?> <?php echo $validacion;?> >
                            <label for="cargo">Cargo</label>
                            <input type="radio" id="rad_usuarioE" name="radiobtnE" value="usuarios" <?php echo $checkedUElabora;?> <?php echo $validacion;?> >
                            <label for="usuarios">Usuarios</label> 
                            
                            <div class="select2-blue">
                                <select <?php echo $validacion;?> class="select2" multiple="multiple" data-placeholder="Seleccione encargado" style="width: 100%;" name="select_encargadoE[]" id="select_encargadoE" required></select>
                            </div>
                        </div>
                        
                        <div class="form-group col-sm-6">
                            <label>Quién revisa: </label><br>
                            <input type="radio" id="rad_cargoR" name="radiobtnR" value="cargos" <?php echo $checkedCRevisa;?> <?php echo $validacion;?>>
                            <label for="cargo">Cargo</label>
                            <input type="radio" id="rad_usuarioR" name="radiobtnR" value="usuarios" <?php echo $checkedURevisa;?> <?php echo $validacion;?>>
                            <label for="usuarios">Usuarios</label>
                            <div class="select2-blue">
                                <select <?php echo $validacion;?> class="select2" multiple="multiple" data-placeholder="Seleccione encargado" style="width: 100%;" name="select_encargadoR[]" id="select_encargadoR" required></select>
                            </div>
                        </div>
                    ...
                    <div class="row" style="display:<?php //echo $display;?>;">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="radio" id="rad_cargoA" name="radiobtnA" value="cargos" <?php echo $checkedCAprueba;?> <?php echo $validacion;?>>
                            <label for="cargo">Cargo</label>
                            <input type="radio" id="rad_usuarioA" name="radiobtnA" value="usuarios" <?php echo $checkedUAprueba;?> <?php echo $validacion;?>>
                            <label for="usuarios">Usuarios</label>

                            
                            <div class="select2-blue">
                                <select <?php echo $validacion;?> class="select2" multiple="multiple" data-placeholder="Seleccione encargado" style="width: 100%;" name="select_encargadoA[]" id="select_encargadoA" required></select>
                            </div>
                        </div>
        ...
        <div class="col">
         ...
         <!-- //// parametros para el tipo de documento y traer los select dinamicos correspondientes -->
          <input id="tipodeSolicitudDocumentos" value="<?php echo $tipoSolicitudAndante;?>" type="hidden">   
...
<script>
    $(document).ready(function(){
        $('#rad_cargoE').click(function(){
            rad_cargo = "cargo";
            $.post("selectDocumentosRechazados.php", { rad_cargo: rad_cargo }, function(data){
                $("#select_encargadoE").html(data);
            }); 
        });
        $('#rad_usuarioE').click(function(){
            rad_usuario = "usuario";
            $.post("selectDocumentosRechazados.php", { rad_usuario: rad_usuario }, function(data){
                $("#select_encargadoE").html(data);
            }); 
        });
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            var idSolicitudDocumento = document.getElementById("tipodeSolicitudDocumentos").value;
            var grupo = radios[i].value;
            var radEncargado = "radEncargado";
            
            //alert(rad_post);
            
            $.post("selectDocumentosRechazados.php", { rad_post: rad_post, grupo: grupo, radEncargado: radEncargado, idSolicitudDocumento: idSolicitudDocumento }, function(data){
                $("#select_encargadoE").html(data);
            }); 
    ...
    $(document).ready(function(){
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            $.post("selectDocumentosRechazados.php", { rad_post: rad_post, grupo: grupo, radRevisar: radRevisar, idSolicitudDocumento: idSolicitudDocumento}, function(data){
                $("#select_encargadoR").html(data);
            }); 
            // only one radio can be logically checked, don't check the rest
            break;
    ...
    $(document).ready(function(){
        ...
        for (var i = 0, length = radios.length; i < length; i++) {
          if (radios[i].checked) {
            ...
            $.post("selectDocumentosRechazados.php", { rad_post: rad_post, grupo: grupo, radAprobar: radAprobar, idSolicitudDocumento: idSolicitudDocumento}, function(data){
                $("#select_encargadoA").html(data);
            }); 
            // only one radio can be logically checked, don't check the rest
            break;
