                ...
                <div class="col-9">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            ?>
                            <button type="button" class="btn btn-block btn-info btn-sm"><a href="proveedoresInscripcionCerrados"><font color="white"><i class="fas fa-list"></i> Listar proveedores</font></a></button>
                            <?php
                            }else{
                            ?>
